(function (config) {
    ...
    function pa() {
        ...
        return 0 <= a.indexOf('nvidia') || 0 <= a.indexOf('quadro') || 0 <= a.indexOf('geforce') || 0 <= a.indexOf('nvs')
            ? ((b = ['nVidia']), 0 <= a.indexOf('geforce') && b.push('geForce'), 0 <= a.indexOf('quadro') && b.push('Quadro'), 0 <= a.indexOf('nvs') && b.push('NVS'), a.match(/\bion\b/) && b.push('ION'), a.match(/gtx\b/) ? b.push('GTX') : a.match(/gts\b/) ? b.push('GTS') : a.match(/gt\b/) ? b.push('GT') : a.match(/gs\b/) ? b.push('GS') : a.match(/ge\b/) ? b.push('GE') : a.match(/fx\b/) && b.push('FX'), (c = a.match(na)) && c[1] && b.push(c[1].toUpperCase().replace('GS', '')), 0 <= a.indexOf('titan') ? b.push('TITAN') : 0 <= a.indexOf('ti') && b.push('Ti'), (b = b.join(' ')))
            : 0 <= a.indexOf('amd') || 0 <= a.indexOf('ati') || 0 <= a.indexOf('radeon') || 0 <= a.indexOf('firegl') || 0 <= a.indexOf('firepro')
            ? ((b = ['AMD']), 0 <= a.indexOf('mobil') && b.push('Mobility'), (c = a.indexOf('radeon')), 0 <= c && b.push('Radeon'), 0 <= a.indexOf('firepro') ? b.push('FirePro') : 0 <= a.indexOf('firegl') && b.push('FireGL'), 0 <= a.indexOf('hd') && b.push('HD'), 0 <= c && (a = a.substring(c)), (c = a.match(na)) && c[1] && b.push(c[1].toUpperCase().replace('HD', '')), (b = b.join(' ')))
            : a.substring(0, 100);
    }
    ...
    var Va = Sa ? 'android' : Ma ? 'ios' : wa ? 'windows' : Ea ? 'mac' : 'other',
        ...
        lb = chrome && !kb && (30 < parseInt(ba.split('chrome/')[1]) || 30 < parseInt(ba.split('crios/')[1])),
        mb = ma('firefox'),
        ...
        xb = tb || wb,
        yb = (function () {
            if (!sb) return ca.devicePixelRatio || 1;
        ...
        Fb = !0 !== window.disableWorker && !sa && !cb && !(eb && Sa) && window.Worker && Eb && Eb.createObjectURL && window.Blob,
        Gb = '',
        qa = '',
        Jb = 0,
        Kb = window.forceWebGL ? { alpha: !0, antialias: !0, depth: !0 } : { alpha: !0, antialias: !0, depth: !0, failIfMajorPerformanceCaveat: !0, preserveDrawingBuffer: !0, stencil: !0 },
        Lb = (function () {
            ...
            for (var a = ['webgl', 'experimental-webgl', 'moz-webgl'], b = null, c = 0; c < a.length; c += 1) {
                ...
                if (b) {
                    ...
                    if (window.forceWebGL) return (Gb = a[c]), (Jb = Infinity), !0;
        ...
        Xb = void 0 !== config[10] ? config[10] : !0,
    ...
    var dc = parseInt(ba.split('chrome/')[1]),
        ec = Vb && Db;
    config.l = { Vra: Ga, Wra: La, size: La ? 100 : Sa ? 200 : 500, pz: Ea, bAa: wa, GD: Ma, hFa: Qa, BJ: Ra, Zl: Sa, ema: Ua, N3: fb, Fz: Va, XH: jb, gwa: ib, CE: ob, E$: hb, Gs: sa, Ai: Wa, vv: Xa, l5: Za, k5: $a, Ve: Ya, n5: bb, Zra: ab, upa: cb, bsa: sa && !ab, Zta: Fa, Iv: ac, Oi: ec && ac && Yb && !sb && chrome, mf: Zb, geolocation: sb || (sa && !Ya) || cb, qza: eb, sL: eb && !chrome, chrome: chrome, l3: !0, dR: mb, ba: sb, lua: sb && Qb, I6: sb && Rb, kua: sb && ca.opera, Kc: va, AL: yb, ja: zb, Uf: xb, K6: ub, HT: vb, R7: wb, una: chrome && 57 <= dc, vna: !sb && chrome && 64 <= dc, D$: Qb, $ra: Ab, EL: Rb, lqa: Sb, dva: Tb, TH: Ub, Fn: Bb, jl: Db, IS: Fb, lA: Xb, Nf: Mb, A$: Gb, B$: Kb, VR: qa, Xta: Jb, CAa: !1, Yp: Vb && !Nb, V1: Vb ? Pb : 'd', r2: Vb ? Lb : !1, dL: ec, sp: Vb && Lb, tFa: Vb && (!Nb || Lb), xq: Wb && !!ca.WebSocket && !jb, eGa: $b, mva: Db || $b ? 'c' : 'd' };
    var fc = config;
    config = void 0;
    var gc = { overlay: ['style'], 'AMap.IndoorMap': ['AMap.CustomLayer', 'cvector'], 'AMap.IndoorMap3D': ['Map3D'], 'AMap.MarkerList': ['AMap.TplUtils'], Map3D: ['vectorlayer', 'wgl', 'AMap.CustomLayer', 'rbush'], 'AMap.Heatmap': ['AMap.CustomLayer'], 'AMap.DistrictLayer': ['MVT'], vectorForeign: ['gridmap', 'MVT'], 'AMap.GltfLoader': ['AMap.CustomLayer', 'Map3D'], 'AMap.LabelsLayer': ['rbush', 'promise'] };
    window.AMap
        ? ((window.AMap.version = '1638773898470'),
          (window.AMap.wL = {
              xM: function (a) {
                  a(fc);
              },
    ...
    fc.Tu = gc;
    for (
        var hc = document.head || document.getElementsByTagName('head')[0],
            ic =
    ...
    var nc = { lang: 1, baseRender: 1, overlayRender: 1, viewMode: 1 };
        ...
        if (!a.fva)
            if (b && (b.innerLayer || b.innerOverlay)) a.y5 = !0;
                ...
                if (c) {
                    ...
                    g.BA.np(c);
                    b = b || {};
                    for (var d in b) b.hasOwnProperty(d) && ('Map' === c && d in nc ? g.BA.np(c, d, b[d]) : g.BA.np(c, d));
                }
            }
    };
    g.da = function () {};
    ...
    g.BA = {
        ...
        send: function () {
            ...
            a.length && ((a = ['type=nfl', 'k=' + g.o.key, 'm=' + (g.l.ba ? 1 : 0), 'pf=' + g.l.Fz, 'v=' + g.o.Xl, 'branch=JSAPI', 'log=' + a.join('!')]), (a = g.o.Cc + '://webapi.amap.com/count?' + a.join('&')), new g.kb.Ab(a));
        },
    };
    ...
    g.va = {
        h: function (a, b, c, d, e) {
            ...
            f[a] = f[a] || [];
            e ? f[a].unshift({ yb: b, cf: c || this, Dj: d }) : f[a].push({ yb: b, cf: c || this, Dj: d });
            return this;
        },
        we: function (a, b, c) {
            var d = this.nf;
        ...
        r: function (a, b) {
            if (!this.we(a)) return this;
            var c = { type: a };
            void 0 !== b && (b instanceof Array ? ((c = b.slice(0)), (c.type = a)) : 'string' === typeof b || 'number' === typeof b || 'boolean' === typeof b ? (c.value = b) : g.a.GJ(b) ? (c.value = b) : (c = g.extend(c, b)));
            for (var d = [].concat(this.nf[a]), e = 0; e < d.length; e += 1) d[e].yb && (d[e].yb.call(d[e].cf || this, c), d[e] && d[e].Dj && this.nf[a] && this.nf[a].splice(e, 1));
            return this;
        },
        ui: function (a) {
    ...
    g.$e = {
        ...
        get: function (a, b, c) {
            ...
            if (!c && this[d]) return (a = !1), !0 == this.C ? (a = !0) : (this.C = !0), (b = this[d](b)), a || (this.C = !1), b;
    ...
    g.o = {
        ...
        fK: { normal: 'normal', dark: 'dark', light: 'light', fresh: 'fresh', test: 'blue', blue_night: 'blue', mapv: 'darkblue', insight: 'grey' },
        key: 'e2b04289e870b005374ee030148d64fd',
        Cc: 'http',
        Td: [115.423412, 39.442759, 117.514625, 41.060816, 116.405285, 39.904989],
        Ed: 'http://restapi.amap.com',
    ...
    function oc(a) {
        ...
        'https' === b && ((g.o.gAa = 'wss'), (g.o.Ed = g.o.Ed.replace('http', 'https')), (g.o.QD = g.o.QD.replace('http', 'https')), (g.o.UJ = g.o.UJ.replace('http', 'https')), (g.o.zU = g.o.zU.replace('http', 'https')), (g.o.QK = g.o.QK.replace('http', 'https')), (g.o.RK = g.o.RK.replace('http', 'https')), (g.o.VE = g.o.VE.replace('http', 'https')), (g.o.yL = g.o.yL.replace('http', 'https')), (g.o.UI = g.o.UI.replace('http', 'https')));
        ...
        var e = '.amap-container{cursor:' + g.o.Doa + ';}.amap-drag{cursor:url(' + b + '://webapi.amap.com/theme/v1.3/closedhand.cur),default;}';
        d.styleSheet
            ? ((b = function () {
                  try {
              ...
              d.styleSheet.disabled ? setTimeout(b, 10) : b())
        ...
        g.o.Nc = a[5];
        g.o.Pla = a[6];
        window._AMapSecurityConfig && (window._AMapSecurityConfig.securityJsCode ? ((g.o.Xa = window._AMapSecurityConfig.securityJsCode), (g.o.ys = '')) : window._AMapSecurityConfig.serviceHost && ((g.o.ys = window._AMapSecurityConfig.serviceHost), (g.o.Ed = g.o.ys), (b = (b = g.o.ys.replace(/http:\/\/\S+?\//g, '')) && b.split('/')[0]), (c = window.location.hostname), '_AMapService' !== b && ('127.0.0.1' === c || 'localhost' === c ? window.alert('\u4f7f\u7528 JSAPI \u5b89\u5168\u6a21\u5f0f\uff0c\u4ee3\u7406\u670d\u52a1\u8bf7\u4ee5_AMapService \u4f5c\u4e3a\u4e00\u7ea7\u8def\u7531') : 'undefined' !== typeof console && console.log('<AMap JSAPI> \u4f7f\u7528 JSAPI \u5b89\u5168\u6a21\u5f0f\uff0c\u4ee3\u7406\u670d\u52a1\u8bf7\u4ee5_AMapService \u4f5c\u4e3a\u4e00\u7ea7\u8def\u7531'))));
        g.o.TQ = a[13];
        pc();
    }
    function pc() {
                ...
                for (var a = window.localStorage.length; 0 <= a; a -= 1) {
                    ...
                    if (b && '_AMap_' === b.slice(0, 6)) {
                        var c = window.localStorage.getItem(b),
                            c = JSON.parse(c || {});
                        '_AMap_anole' === b ? c.version !== g.l.mf && window.localStorage.removeItem(b) : '_AMap_data.tileKeys' === b ? (c.vdataVer === g.l.mf && c.apiVer === g.o.Ek) || window.localStorage.removeItem(b) : c.version !== g.o.Ek && window.localStorage.removeItem(b);
                    }
                }
        } catch (d) {}
    }
    window.AMap && window.AMap.wL && window.AMap.wL.xM && window.AMap.wL.xM(oc);
    g.Nm = { Ru: Math.PI / 180, kwa: 180 / Math.PI, RQ: 6378137 };
    (function () {
        function a(a) {
        ...
        g.ai = {
            gra: function (b) {
                ...
                if (g.l.ba) {
                    var d = [g.o.Kv + '/callAPP?', 'src=jsapi_q'];
                    ...
                    d.push('&mo=' + encodeURIComponent(g.o.Kv + '?q=' + c.join(',') + '&callapp=0&sourceApplication=jsapi_q'));
                    return d.join('');
                }
            ...
            w4: function (b) {
                ...
                if (g.l.ba) {
                    var d = [g.o.Kv + '/callAPP?', 'src=jsapi_p'];
            ...
            u4: function (b) {
                if (g.l.ba) {
                    var c = [g.o.Kv + '/callAPP?', 'src=jsapi_detail'];
                    ...
                    c.push('&mo=' + encodeURIComponent(g.o.Kv + '/detail/index/poiid=' + b.id + '&sourceApplication=jsapi_detail'));
                    return c.join('');
                }
            ...
            MR: function (b) {
                ...
                if (g.l.ba) {
                    var d = [g.o.Kv + '/callAPP?', 'src=jsapi_r_' + b.t];
                    ...
                    d.push('&mo=' + encodeURIComponent(g.o.Kv + '/?r=' + c.join(',') + '&callapp=0&sourceApplication=jsapi_r_' + b.t));
                    return d.join('');
                }
    ...
    g.a = {
        ...
        H4: function (a, b, c) {
            ...
            switch (3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : 'linear') {
                case 'ease':
                    c = g.Mw.GI(0.25, 0.1, 0.25, 1)(c);
                    break;
                case 'ease-in':
                    c = g.Mw.GI(0.42, 0, 1, 1)(c);
                    break;
                case 'ease-out':
                    c = g.Mw.GI(0, 0, 0.58, 1)(c);
                    break;
                case 'ease-in-out':
                    c = g.Mw.GI(0.42, 0, 0.58, 1)(c);
            }
            var e = a + (b - a) * c;
            d && (e >>= 0);
            return e;
        ...
        lDa: function (a) {
            if (/^rgba\(/.test(a)) return this.Zv(a);
            var b = (a = this.nI(a));
            '#' === a[0] &&
                ((a = a.substring(1)),
                3 === a.length &&
        ...
        am: function (a) {
            ...
            if (0 == a.indexOf('#')) {
                if (4 === a.length)
                    return (
                        (a = a.substr(1).replace(/./g, function (a) {
                            return a + a;
                        })),
                        this.qp(a)
                    );
                ...
                if (0 == a.indexOf('rgba(')) return this.Zv(a);
            }
        },
        D8: function (a) {
            return g.a.Sr('ff' + a);
        ...
        Hna: function (a, b, c) {
            return 'function' == typeof b ? this.MP(a, !0, this.Cma(b, c, 1)) : this.MP(a, !0);
        },
        ...
        Cma: function (a, b, c) {
            if ('function' != typeof a) return this.uv;
        ...
        iepngFix: function (a) {
            ...
            window.DD_belatedPNG && this.GS
                ? setTimeout(function () {
                      b();
                  }, 100)
                : this.GS || g.ub.load('AMap.FixPng', b);
        },
        Ka: function (a) {
            if (g.a.isArray(a))
                if (g.a.isArray(a[0])) for (var b = 0; b < a.length; b += 1) a[b] = g.a.Ka(a[b]);
        ...
        Mq: function (a) {
            return g.a.isArray(a) ? new g.yd(a[0], a[1]) : a;
        },
        FP: function (a) {
            var b = a.type,
                c = a.WU,
                d = a.error;
            a = new g.kb.XMLHttpRequest(a.url, { Gd: void 0 === b ? 'GET' : b, Q2: a.data, rU: 'text/plain' });
            a.h(
                'complete',
                function (a) {
                    a = JSON.parse(a.data);
    ...
    g.a.sU = window.requestIdleCallback
        ? function (a, b) {
    ...
    g.a.bQ = window.cancelIdleCallback
        ? function (a) {
            ...
            f.getCurrentPosition(
                ...
                function (b) {
                    l ||
                        (clearTimeout(k),
                        (k = void 0),
                        2 === b.code && 0 < b.message.indexOf('permission')
                            ? a.ub.load('AMap.GeoRemoteLoc', function () {
                                  d(null, a.saa, h);
                              })
                            : d(null, f));
                },
    ...
    (function (a) {
        var b = a.da.extend({ ka: [a.va], A: function () {} });
        a.Mj = new b();
    })(g);
    (function (a) {
        var b = a.da.extend({
            ...
            Bxa: function (a, b) {
                if (b) {
                    var e = b.map;
                    e && (e.RN ? e.RN.toString() : '') !== (a ? a.toString() : '') && ((e.RN = a || []), e.set('display', 0));
                }
            },
            Y8: function (a, b) {
                if (b) {
            ...
            RBa: function () {},
            DZ: function (a, b) {
                if (a) for (var e = 0, f = a.length; e < f; e++) a[e] && 0 > b.indexOf(a[e]) && b.push(a[e]);
            },
            D3: function (b) {
                if (!b) return null;
                b = b.map.la;
                for (var d = 0, e = b.length; d < e; d++)
                    if (a.q.fi && b[d] instanceof a.q.fi && b[d].ha && b[d].ha.length && (-1 !== b[d].ha.indexOf('building') || -1 !== b[d].ha.indexOf('poilabel')) && b[d].Ra) {
            ...
            Vfa: function (a) {
                if (a.tp && a.tp.qe) {
                    ...
                    if (b) {
                        var e = [];
                        this.DZ(b, e);
                        this.r('vecTileParsed.builds.found', { o2: e, tp: a.tp });
                    }
                }
            },
        });
    ...
    (function (a) {
        ...
        function d(a) {
            function b(c, d) {
                function e(a, b, c) {
                    a = { bA: Date.now(), Qz: h, error: a, result: b, Iq: !1, dl: !1 };
        ...
        a.extend(e.prototype, {
            ...
            lka: function () {
                ...
                this.B0 = a;
                if (this.Sx) {
                    for (var b = 0, c = this.Sx.length; b < c; b++) this.Sx[b].apply(null, a);
                    this.Sx.length = 0;
                }
            },
            Au: function (a) {
            ...
            nT: function (a) {
                this.B0 ? a.apply(null, this.B0) : (this.Sx || (this.Sx = []), this.Sx.push(a));
            },
            ny: function (b) {
                var c = this;
                if (!c.IX) {
                    ...
                    a.l.IS
                        ? this.Zja(function (a, b) {
                              b
                                  ? this.vga(b, function (a, c) {
                                        a ? d(a) : (this.RB(c), (this.BP = c), (this.Sp.length = 0), (this.mo = null), d(null, { Ama: b, dAa: c }));
                                    })
            ...
            xf: function (b, c) {
                ...
                f.nT(function (a) {
                    a
                        ? d(a)
                        : f.BP
                        ? ((a = f.SY(c, f.DN(f.YA, b), !0)),
                          f.BP.sendMessage(e.UR + ':injectCode', a, function (a, b) {
                              a || f.RB(f.BP, h);
                              d(a, b);
                          }))
            ...
            RB: function (a, b) {
                ...
                else if (this.mo) for (var c in b) b.hasOwnProperty(c) && (this.mo[c] = b[c]);
                for (c in b)
                    if (b.hasOwnProperty(c)) {
                        var d = b[c];
                        'function' === typeof d && (this[c] = this.vfa(c, d, a));
                    }
                this.cka = !!a;
            },
            SY: function (a, b) {
            ...
            Zja: function (a) {
                ...
                c && c !== r
                    ? c.nT(function (b, c) {
                          b
                              ? a.call(r, b)
                              : c.dAa.sendMessage(e.UR + ':injectCode', h, function (b) {
            ...
            Qda: function (b) {
                ...
                return function (h) {
                    ...
                    r = { bA: a.a.eg(), iS: e.DN(u, w), DC: !!s, Qz: u + '_' + c++, nQ: h, jma: r };
                    s && d.push({ nQ: r.nQ, iS: r.iS, bA: r.bA, Qz: r.Qz, DC: s });
                    f ? e.zca(b, r) : e.Qx(b, r);
                };
            },
            Qx: function (a, b) {
                if (this.Sp.length) {
                    try {
                        a.postMessage(b, this.Sp);
                    } catch (c) {
            ...
            zca: function (b, c) {
                ...
                if (!b.s0) {
                    ...
                    b.s0 = setTimeout(function () {
                        b.s0 = null;
                        var c = b.xO;
                        c.length && (d.Qx(b, 1 === c.length ? c[0] : { bA: a.a.eg(), Vwa: c }), (c.length = 0));
                    }, 0);
                }
            },
            gla: function (a) {
            ...
            vga: function (a, b) {
                ...
                c.gla(a);
                var d = this.Qda(a);
                if (e.vda) b.call(c, null, { sendMessage: d });
                else {
                    e.vda = !0;
                    var f = [
                        c.LY() + ':checkup',
        ...
        if (!g.VL) {
            ...
            b.send = function (b) {
                var c = d.Cc + '://webapi.amap.com/count?',
                    k = g.extend(e({ K: a.DD[b.id].K }), b.params || {}),
                    l = g.a;
                b.params && b.params.rs && !b.params.type && ((b = a.DD[b.id].time), delete b.w5, (k = g.extend(k, b)));
                b = [];
                for (var m in k) l.isArray(k[m]) ? b.push([m, k[m].join('-')].join('=')) : b.push([m, k[m]].join('='));
                b.push('jl=' + (d.OJ ? 1 : 0));
                if (l.kk(window.performance, 'performance') && l.kk(window.performance.getEntriesByType, 'function')) {
                    var n = 0,
            ...
            var e = function (a) {
                var b = g.l;
                a = g.f.U3(a.K);
                return { type: 'q', resolution: a.width + '*' + a.height, k: d.key, u: d.Ao, iw: b.Nf ? 1 : 0, cw: b.r2 ? 1 : 0, gc: b.VR, m: b.ba ? 1 : 0, cv: b.Yp ? 1 : 0, pf: b.Fz, dpr: window.devicePixelRatio, screenwidth: screen.width, scale: b.AL || 0, detect: b.ja ? 1 : 0, v: d.Xl };
            };
        }
    })();
    (function () {
        if (!g.JL) {
            var a = g.a.oD({ o: 'Conf', extend: 'extend', l: 'Browser', zw: 'uncodeCoords' });
            g.JL = function () {
                var b = new g.KA(
                    function () {
                        return {
                            ...
                            yh: function (a, b) {
                                var e = a.Od,
                                    f = a.Je,
                                    h = 'building' === a.ha[0];
                                ((f && e !== this.rx.oE && this.rx.oE) || (!f && !h && e !== this.rx.pk && this.rx.pk)) && this.Nla(!!f);
                                f ? (this.rx.oE = e) : h || (this.rx.pk = e);
                                this.sta(a, b);
                            },
                            Nla: function (a) {
                                if (a) this.iX();
                                else if (!a && Object.keys(this.Sk).length) for (var b in this.Sk) this.Sk.hasOwnProperty(b) && ((a = this.Sk[b]), a.Ot || a.abort());
                            },
                            Mya: function () {
                                this.Tt > this.f_ && this.dU(Object.keys(this.Wj).slice(0, Math.floor(this.f_ / 2)));
                            },
                            dU: function (a) {
                            ...
                            sta: function (a, b) {
                                function e(e, f) {
                                    ...
                                    if (p.Sk[q.AE] || p.kga(q)) {
                                        ...
                                        else p.Ws(p.extend({}, a, { fF: t, Od: h, Dn: m, AS: !0 }), b);
                                        return x;
                                    }
                                    r || (p.Ml(l, b), (r = !0));
                                }
                                ...
                                if (
                                    ...
                                    q.onreadystatechange = function () {
                                        if (4 === q.readyState && 0 === q.status) q.Ot || ((q.Ot = !0), f.Ml(l, b), (q.onreadystatechange = null), k ? f.G0(q) : delete f.Sk[q.AE]), (q = null);
                                        else if (!q.Ot)
                                            if (3 === q.readyState) {
                                                var h = q.responseText.substring(n);
                                                q.Oq = e(h, q.Oq);
                                                n = q.responseText.length;
                                            } else 4 === q.readyState && ((h = q.responseText.substring(n)), a.Di && (h += '|'), e(h, q.Oq, !0), (q.Oq = ''), k ? f.G0(q) : delete f.Sk[q.AE], (q = null));
                                    };
                                    q.onerror = function () {};
                                    q.open('GET', m, !0);
                                    q.send();
                                    k &&
                                        (q.V9 = l.map(function (a) {
                                            return a.key;
                                        }));
                                }
                            },
                            bE: function (a) {
                                function b(d, p, r) {
                                    ...
                                    if (d && 'loaded' !== d.status && -1 !== m.indexOf(t))
                                        if ('limg' === t) (p = h[1]), (d.sd = p), 'string' === typeof p.b && (p.b = w.cB(p.b)), (r = ''), (r = 'object' === typeof p.u ? p.u.url : p.u) && (p.u = { url: r, Ck: 'limg-' + d.key + '-' + f });
                                        else {
                                            p = { Ig: d.ta, Pi: s, Oa: h, Gd: t, ky: a.Fu, HD: 'building' === t, Ci: 'poilabel' === t || 'roadlabel' === t || ('building' === t && q) };
                                            if ('poilabel' === t || 'roadlabel' === t) p.sd = d.sd;
    ...
    g.f = {
        ...
        nJ: function (a) {
            if (a) return new g.yd(a.clientWidth || document.body.clientWidth, a.clientHeight || (g.l.Gs ? ('CSS1Compat' === document.compatMode ? document.documentElement.clientHeight : document.body.clientHeight) : document.body.clientHeight), !0);
        },
        U3: function (a) {
            return new g.yd(a.clientWidth, a.clientHeight);
        },
        TR: function (a) {
            var b = 0,
                c = 0,
            ...
            do {
                ...
                b -= d.scrollTop || 0;
                c -= d.scrollLeft || 0;
                g.f.Zoa() || (!g.l.D$ && !k) || ((c += d.scrollWidth - d.clientWidth), k && 'hidden' !== g.f.$c(d, 'overflow-y') && 'hidden' !== g.f.$c(d, 'overflow') && (c += 17));
                d = d.parentNode;
            } while (d);
            return new g.H(c, b);
        },
        ...
        c9: function (a, b, c) {
            a.bj = b;
            !c && g.l.TH ? ((b = g.f.I4(b)), (c = a.style[g.f.qg].split('rotate')), 1 < c.length ? ((c[0] = b), (a.style[g.f.qg] = c.join('rotate'))) : (a.style[g.f.qg] = b), g.l.I6 && (a.style.WebkitBackfaceVisibility = 'hidden')) : ((a.style.left = b.x + 'px'), (a.style.top = b.y + 'px'));
        },
        Wd: function (a) {
            a.bj || (a.bj = a.style.left ? new g.H(parseInt(a.style.left), parseInt(a.style.top)) : new g.H(0, 0));
            return a.bj;
        },
        xHa: function (a, b) {
    ...
    g.f.qt = { transform: 'transform', WebkitTransform: '-webkit-transform', OTransform: '-o-transform', MozTransform: '-moz-transform', msTransform: '-ms-transform' };
    ...
    g.F = {
        ...
        G: function (a, b, c, d) {
            ...
            g.l.R7 && -1 < b.indexOf('touch') ? this.Bwa(a, b, c) : g.l.Uf && 'dblclick' === b && this.xwa ? this.xwa(a, c) : 'removeEventListener' in a ? a.removeEventListener(b, e, !1) : 'detachEvent' in a && -1 === b.indexOf('touch') ? e && a.detachEvent('on' + b, e) : (a['on' + b] = null);
            a[d] = void 0;
            return this;
        },
        DHa: function (a, b) {
        ...
        dya: function (a) {
            ...
            g.l.K6 && (g.F.h(a, 'MSPointerDown', b, this), g.F.h(a, 'MSPointerUp', b, this), g.F.h(a, 'MSPointerMove', b, this));
        },
        ...
        txa: function (a) {
            return a && a.getBoundingClientRect ? ((a.tM = a.getBoundingClientRect()), (a.UW = [a.clientLeft, a.clientTop]), !0) : !1;
        },
        uza: function (a) {
    ...
    g.extend(g.F, {
        ...
        Yla: function (a, b, c, d) {
            ...
            this.j_ ||
                ...
                document.documentElement.addEventListener(this.Po('pointerup'), a, !1),
                document.documentElement.addEventListener(this.Po('pointercancel'), a, !1),
                (this.j_ = !0));
            return this;
        },
        ...
        Wla: function (a, b, c, d) {
            ...
            a.addEventListener(this.Po('pointercancel'), e, !1);
            return this;
        },
        Bwa: function (a, b, c) {
            c = a['_amap_' + b + c];
    ...
    (function () {
        ...
        g.extend(g.F, {
            ...
            TGa: function (b, d) {
                ...
                b.Cp.length || (c ? b.detachEvent('onresize', a) : (b.Dp.contentDocument.defaultView.removeEventListener('resize', a), (b.Dp = !b.removeChild(b.Dp))));
            },
            Ena: function (a) {
                a.Cp = null;
                if (a.Dp) {
    ...
    g.ub = {
        ...
        $Q: function (a, b) {
            ...
            if (1 === c.status) b && b();
                ...
                b && c.oy.push(b);
                try {
                    if (g.l.Iv && window.localStorage) {
                        var d = window.localStorage['_AMap_' + a];
                        d && ((d = JSON.parse(d)), d.version === g.o.Ek ? (window._jsload_(a, d.script, !0), d.css && window._cssload_(a, d.css, !0)) : window.localStorage.removeItem('_AMap_' + a));
                    }
                } catch (e) {}
                if (0 === c.status) {
                    this.ewa(a);
                    ...
                    f.ZS ||
                        ...
                        window.setTimeout(function () {
                            f.ZS = 0;
                            var a = f.mua + '/modules?v=' + g.o.Xl + '&key=' + g.o.key + '&m=' + f.Ez.join(',') + '&vrs=' + g.o.Ek;
                            g.ub.Rt(f.Ez.join(','));
                            f.Ez = [];
                            c.VK = f.Dta(a);
                        }, 1));
        ...
        On: function (a, b) {
            ...
            c.status = 1;
            for (var e = 0, f = c.oy.length; e < f; e += 1) c.oy[e]();
            c.oy = [];
        },
        qd: function (a, b) {
            var c = this;
        ...
        SC: function (a) {
            this.Ou[a] || ((this.Ou[a] = {}), (this.Ou[a].status = 0), (this.Ou[a].oy = []));
            return this.Ou[a];
        },
        remove: function (a) {
            this.Ou[a] = null;
    ...
    window._jsload_ = function (a, b, c) {
        ...
        d.VK = null;
        try {
            if (!c && window.localStorage && b && '' !== b && g.l.Iv) {
                var e = window.localStorage['_AMap_' + a],
                    e = e || '{}',
                    e = JSON.parse(e);
                e.version !== g.o.Ek || e.script ? window.localStorage.setItem('_AMap_' + a, JSON.stringify({ version: g.o.Ek, script: b })) : window.localStorage.setItem('_AMap_' + a, JSON.stringify({ version: g.o.Ek, script: b, css: e.css }));
            }
        } catch (f) {}
        g.ub.On(a, b);
    };
    window._cssload_ = function (a, b, c) {
        try {
            !c && window.localStorage && b && '' !== b && g.l.Iv && window.localStorage.setItem('_AMap_' + a, JSON.stringify({ css: b, version: g.o.Ek }));
        } catch (d) {}
            ...
            if (c) {
                ...
                g.indexedDB = {
                    mC: function (a, b) {
                        f
                            ? 'function' === typeof a && a()
                            : h.h('dbReady', function (c) {
                                  'success' === c.status ? 'function' === typeof a && a() : 'function' === typeof b && b({ code: 3, status: status });
                              });
                    },
                    count: b(function (a) {
                        var b = this,
    ...
    (function () {
        ...
        function e() {
            var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : r.Ts;
            k();
        ...
        function k() {
            u.data = { vdataVer: q.mf, apiVer: g.o.Ek, keys: [], config: {}, fsTiles: {} };
            u.rt = {};
        }
        function l(a) {
        ...
        function n(a) {
            if ('object' === typeof a && null !== a) {
                ...
                else for (d in ((b = {}), a)) a.hasOwnProperty(d) && (b[d] = n(a[d]));
                return b;
            }
            return a;
        }
        ...
        if (!g.Oj && q.Oi) {
            var s = g.indexedDB,
                u = { XL: 1e3, key: '_AMap_data.tileKeys' },
                v = [],
                w = {
                    ...
                    setItem: function (a, b, c) {
                        var d = b;
                        c && ((d = JSON.stringify(b)), 1.5 < d.length / 1024 / 1024 && Object.keys(b.iqa).length && ((b.iqa = {}), (d = JSON.stringify(b))));
                        try {
            ...
            g.Oj = {
                ...
                get: function (c, d) {
                    function f(a) {
                        var b = { kS: l, H6: G, UFa: w, Ug: u.data.config };
                        a &&
                            B.length &&
                            (/\|limg/.test(B[0])
                                ? (b.n6 = a
                    ...
                    var k = 'FS' === c.type;
                    if (!q.Iv || !(k || (q.Oi && 0 !== u.data.keys.length))) return d({ code: 1 });
                    var l = [],
                        w = [],
                        B = [],
                        G = [],
                    ...
                    c.xya.forEach(function (a) {
                        var d = !1,
                            e = b({ Pi: a.key, url: c.url, Nf: c.Nf, ja: c.q.ja, Be: c.Be });
                        k && (v.push(e), u.data.fsTiles[e] && (l.push(a), B.push(e), H.push({ data: p(u.data.fsTiles[e]), tileKey: e }), (d = !0)));
                    ...
                    s.get(B, { timeout: c.timeout || 1e3 }, function (b, c) {
                        if (b || c.length !== B.length) b && 3 === b.code ? (q.Oi = !1) : e(), (G = w), (w = []), f(null);
                        else {
                            if (k)
                ...
                Aw: function (a) {
                    a.Jb.forEach(function (c) {
                        c = b({ Pi: c.key, url: a.url, Nf: a.Nf, ja: a.q.ja, Be: a.Be });
                ...
                flush: (function () {
                    ...
                    return function () {
                        ...
                        if (a) {
                            ...
                            q.Oi
                                ? s.count(function (a, c) {
                                      a ||
                                          (c !== u.data.keys.length
                                              ? (u.data.keys.length && (u.data.keys = []),
                                                f(function () {
                                                    b.tG(!0);
                                                }))
                                              : b.tG(!0));
                    ...
                    f.length
                        ? (f.forEach(function (a) {
                              ...
                              a
                                  ...
                                  ? (r.ka(u.data.keys, a) || (h.push(a), d.push({ tileKey: a, data: c })), r.ka(v, a) && void 0 === u.data.fsTiles[a] && (u.data.fsTiles[a] = c))
                                  : (b[a] = c);
                          }),
                          d.length &&
                              (q.Oi
    ...
    g.U = g.da.extend({
        ...
        toString: function () {
            return g.a.xb(this.R, 6) + ',' + g.a.xb(this.Q, 6);
        },
        xl: function () {
    ...
    g.U.Pqa = function (a, b, c) {
        ...
        var s = b.Q * f;
        b = b.R * f;
        for (var k = 2 * k(l(n(m((r - s) / 2), 2) + p(r) * p(s) * n(m((a - b) / 2), 2))), u, v, w, t, f = 1; f < c; f += 1) (u = (1 / c) * f), (v = m((1 - u) * k) / m(k)), (w = m(u * k) / m(k)), (u = v * p(r) * p(a) + w * p(s) * p(b)), (t = v * p(r) * m(a) + w * p(s) * m(b)), (v = v * m(r) + w * m(s)), (v = q(v, l(n(u, 2) + n(t, 2)))), (u = q(t, u)), b > a ? (u < a && (u += 2 * e), u > b && (u -= 2 * e)) : (u > a && (u -= 2 * e), u < b && (u += 2 * e)), d.push(new g.U(u * h, v * h, !0));
        return d;
    };
    g.U.Yb({ CR: 'getLng', zR: 'getLat', add: 'add', bb: 'subtract', md: 'divideBy', Pd: 'multiplyBy', He: 'distance', offset: 'offset', hb: 'equals', toString: 'toString' });
    g.pe = g.da.extend({
        A: function () {
        ...
        eb: function () {
            return new g.pe(this.wc.eb(), this.oc.eb());
        },
        hb: function (a) {
        ...
        fV: function (a) {
            var b = [this.kv(), this.Qo(), this.Ry(), this.ek()];
            a && b.push(this.kv());
            return new g.vp(b);
        },
        Bya: function (a) {
    ...
    g.pe.Yb({ kv: 'getSouthWest', Ry: 'getNorthEast', ek: 'getNorthWest', Qo: 'getSouthEast', contains: 'contains', $g: 'intersects', yi: 'getCenter', extend: 'extend' });
    g.H = g.da.extend({
        A: function (a, b, c) {
    ...
    g.H.Yb({ wf: 'getX', ve: 'getY', add: 'add', bb: 'subtract', md: 'divideBy', Pd: 'multiplyBy', He: 'distance', hb: 'equals', toString: 'toString' });
    g.yd = g.da.extend({
        A: function (a, b, c) {
        ...
        eb: function () {
            return new g.yd(this.width, this.height);
        },
        wj: function () {
            return this.width;
        },
        ...
        hb: function (a) {
            return a instanceof g.yd && this.width === a.width && this.height === a.height;
        },
        toString: function () {
            return this.wj() + ',' + this.uj();
        },
    });
    g.yd.Yb({ wj: 'getWidth', uj: 'getHeight', toString: 'toString' });
    g.vp = g.da.extend({
        A: function (a) {
        ...
        uR: function (a) {
            for (var b = [], c = 0; c < this.path.length; c += 1) b[c] = a.lc(this.path[c], 20);
            return b;
        },
        rR: function (a) {
    ...
    g.Xf = g.da.extend({
        ...
        contains: function (a) {
            var b;
            a instanceof g.Xf ? ((b = a.kc), (a = a.Xd)) : (b = a);
    ...
    g.Bp.vW = {
        ...
        Xh: function (a, b) {
            for (var c = 180 / Math.PI, d = this.hM, e = this.iM, f = (a.x * c) / d, d = e / d, d = Math.sqrt(1 - d * d), e = Math.exp(-a.y / e), h = Math.PI / 2 - 2 * Math.atan(e), k = 15, l = 0.1; 1e-7 < Math.abs(l) && ((k -= 1), 0 < k); ) (l = d * Math.sin(h)), (l = Math.PI / 2 - 2 * Math.atan(e * Math.pow((1 - l) / (1 + l), 0.5 * d)) - h), (h += l);
    ...
    g.$h.cW = g.extend({}, g.$h.rF, { code: 'EPSG:4326', Qf: g.Bp.rW, WE: new g.MF(1 / 360, 0.5, -1 / 360, 0.25) });
    g.$h.$Aa = g.extend({}, g.$h.rF, { Qf: g.Bp.rW, WE: new g.MF(1, 0, 1, 0) });
    g.TJ = {
        lc: function (a, b) {
            a = g.a.Ka(a);
        ...
        pEa: function (a) {
            return a ? this.lc(this.get('center'), a) : this.get('centerPixel');
        },
        IBa: function (a) {
            return new g.H(a.x + 2.0037508342789244e7, 2.0037508342789244e7 - a.y).md(0.14929107086948487);
        },
        v7: function (a) {
    ...
    z.Sb = g.da.extend({
        ...
        setVectorMapForeign: function (a) {
            if (g.l.Yp) {
                ...
                var d = this,
                    b = [];
                a && (b.push('gridmap'), b.push('MVT', 'vectorForeign'), b.push('labelcanvas'));
                g.ub.Gg(b, function () {
                    d.s6(function () {
                        d.map && ((d.map.Gi = !0), d.map.GG && d.map.GG(), d.map.Se && d.map.Se instanceof g.Sb.EF && d.map.Se.je && d.map.Se.je.S && (d.map.Se.je.S.fI(), (d.map.Se.je.S.M6 = c), d.map.Se.je.S.reload()), d.set('display'));
                    });
                });
            }
        },
        setMapStyle: function (a) {
            ...
            a = a || 'normal';
            -1 === a.indexOf('amap://styles/') ? (g.o.fK[a] ? this.set('styleUrl', 'amap://styles/' + g.o.fK[a]) : this.set('styleUrl', '')) : this.set('styleUrl', a);
            this.aT();
        },
        ...
        setLang: function (a) {
            ...
            ('en' !== a && 'zh_cn' !== a && 'zh_en' !== a) || a === this.get('lang', null, !0) || (this.set('lang', a), this.ik && this.ik.B8(this));
        },
        getLang: function () {
        ...
        setCity: function (a, b) {
            ...
            var c = this,
                d = g.o.Ed + '/v3/config/district?subdistrict=0&extensions=all&key=' + g.o.key + '&s=rsv3&output=json&keywords=' + a;
            g.o.Xa && (d += '&jscode=' + g.o.Xa);
            new g.kb.Ab(d, { callback: 'callback' }).h(
                'complete',
                function (d) {
                    var f = d.districts;
                    if (f && f.length) {
        ...
        getCity: function (a, b) {
            ...
            var c = g.o.Ed + '/v3/geocode/regeo?&extensions=&&key=' + g.o.key + '&s=rsv3&output=json&location=' + (b || this.get('center', null, !0));
            g.o.Xa && (c += '&jscode=' + g.o.Xa);
            new g.kb.Ab(c, { callback: 'callback', iy: !0, Gd: 'REGEO' }).h(
                'complete',
                function (b) {
                    b = b.regeocode.addressComponent;
                    a({ province: b.province, city: b.city instanceof Array ? '' : b.city, citycode: b.citycode instanceof Array ? '' : b.citycode, district: b.district instanceof Array ? '' : b.district });
                },
                this
            );
        },
        A: function (a, b) {
            ...
            b.preloadMode = !1;
            g.l.IS ? !1 !== b.workerMode && (z.Sb.Rt ? ((b.workerMode = !1), z.Sb.Rt++) : (z.Sb.Rt = 1)) : (b.workerMode = !1);
            ...
            'pitchEnable' in b || '3D' !== b.viewMode || !g.l.sp || this.set('pitchEnable', !0);
                ...
                e.s6(function () {
                    g.ub.Gg(f, function () {
                        if (!e.get('destroy')) {
                            ...
                            g.l.jl && e.Rla();
                            e.C = !0;
                            '3D' === e.view.type && (e.AmbientLight || (e.AmbientLight = new g.Uw.RV([1, 1, 1], 0.9)), e.DirectionLight || (e.DirectionLight = new g.Uw.aW([0, -1, 1], [1, 1, 1], 0.1)));
                            e.C = !1;
                        }
                    });
                });
                ...
                if (b)
                    if (((g.RJ = 0), (g.QJ = 0), 'string' == typeof b && 'style_' == b.substr(0, 6))) {
                        var c = this,
                            d,
                            e = b.slice(6);
                        32 == e.length ? ((c.ks = !0), (g.o.cqa = g.o.UI + 'style_local/'), (d = g.o.Ed + '/v4/sdk/map/styles?styleid=' + e + '&key=' + g.o.key + '&sdkType=abroad_js_json&s=rsv3'), (d += '&platform=JS&logversion=2.0'), (d += '&appname=' + g.o.Ao), (d += '&csid=' + g.a.Dw()), (d += '&sdkversion=' + g.o.Xl), g.o.Xa && (d += '&jscode=' + g.o.Xa)) : ((c.ks = !1), (g.o.cqa = g.o.UI + b + '/'), (d = g.o.Hb + '/styles/foreign/web_v8_' + b + '.json'));
                        var f = new g.kb.XMLHttpRequest(d, { rU: 'application/json', responseType: 'json' });
                        f.h(
                            'complete',
                            function (b) {
                                if (b && b.data && !b.data.ODa) {
                                    ...
                                    if (d) {
                                        ...
                                        for (var e = 0, f = d.length; e < f - 1; e += 2) {
                                            ...
                                            g.qy.push([h.x >> 0, h.y >> 0]);
                                        }
                                    }
                                    (d = b.style) && d.layers && ((g.Qta = d.layers), b.zoomlevel && ((g.RJ = b.zoomlevel[0]), (g.QJ = b.zoomlevel[1])));
                                } else (c.ks = !1), c.set('vectorMapForeign', !1);
                                a();
                            },
                            this
                        );
                    ...
                    } else (this.ks = !1), this.set('vectorMapForeign', !1), a();
                else (this.ks = !1), this.set('vectorMapForeign', !1), a();
            } catch (h) {
                (this.ks = !1), this.set('vectorMapForeign', !1), a();
            }
        },
        Hta: function (a) {
            function b() {
            ...
            if (g.l.Ve || g.Ue) a();
                ...
                if (c) b(), a();
                    ...
                    f.onload = function () {
                        if (!g.Ue) {
                            if (AMap.anole && !window.__AMapStyleSource && g.l.Iv)
                                try {
        ...
        toa: function (a, b) {
            if (b instanceof g.U) {
                ...
                if (a.pointToLngLat && a.lngLatToPoint) return { nE: a.pointToLngLat, OD: a.lngLatToPoint, oq: a.getResolution };
        ...
        Nxa: function (a, b) {
            ...
            e &&
                ((this.cx = new g.Lj(d, a, null, 0)),
                (this.cx.transition = function (a, c, e) {
                    e /= b || 300;
                    if (1 <= e) return c;
                    var f = {},
                        h;
                ...
                (this.cx.Kq = function (b) {
                    b === a && (this.cx.stop(), (this.Hd = null));
                    for (var c in b) b.hasOwnProperty(c) && ('center' === c ? ((this.C = !0), this.setCenter(b[c], !0), (this.C = !1)) : this.set(c, b[c]));
                }),
                this.cx.On(this));
        },
        voa: function (a) {
            '3D' === this.get('viewMode') && g.l.sp ? (this.set('baseRender', 'vw'), (this.view = new g.sM(this, a))) : (this.view = new g.PF(this, a));
            this.q5();
        },
        q5: function () {
        ...
        eQ: function () {
            ...
            if (this.view && '3D' !== this.view.type) {
                ...
                if (a && !('dv' < a)) {
                    ...
                    b && c && (g.l.Yp && (d || 'all' !== b || ('normal' !== c && 'amap://styles/normal' !== c)) ? (this.set('baseRender', 'v'), (this.wT = a)) : this.wT && (this.set('baseRender', this.wT), (this.wT = null)));
                    this.q5();
                }
            }
        },
        Rla: function () {
            ...
            !a.sm &&
                a.K &&
                ((a.indoorMap = a.sm = new AMap.IndoorMap({ innerLayer: !0 })),
                a.MU(),
                g.a.Xc(function () {
        ...
        layersChanged: function () {
            ...
            this.$J = this.C = !1;
            for (var b = 0; b < a.length; b += 1) (a[b].C = !0), a[b].getMap() !== this && a[b].setMap(this), (a[b].C = !1), a[b].$J && (this.$J = !0);
            this.MU();
        },
        ...
        v$: function () {
            ...
            if (!this.f8) {
                ...
                if (d && !c) this.tk(d), this.set('rasterLayer', void 0);
                else if (!d && c && this.get('layers')) {
                    d = new z.q.sb({ innerLayer: !0, map: this, Uv: !0, zIndex: 0 });
                    d.Jsa = !0;
                    if (this.w.layers) {
                        var e = null;
                        g.a.Ub(this.w.layers, function (a) {
                            a instanceof z.q.sb && a.HG && (null === e || a.get('zIndex') > e.get('zIndex')) && (e = a);
                        });
        ...
        kna: function (a) {
            ...
            a.layers && 0 !== a.layers.length ? this.set('defaultLayer', a.layers[0], !0) : ((b = new z.q.sb({ innerLayer: !0 })), (a.layers = [b]), (b.IP = !0), this.set('defaultLayer', b, !0));
        ...
        uC: function (a) {
            ...
            0 <= g.a.indexOf(b, a) || (a instanceof z.B.Un ? (this.get('overlays').push(a), this.uy instanceof z.B.Un && ((this.uy.C = !0), this.uy.close(), (this.uy.C = !1)), (this.uy = a), this.set('contextmenu', a, !0)) : (a instanceof z.B.Ze && (this.tm instanceof z.B.Ze && this.Lz(this.tm), (this.tm = a)), this.get('overlays').push(a)), this.r('overlays'));
        },
        tk: function (a) {
            var b = this.get('layers'),
                c = g.a.indexOf(b, a);
        ...
        getTileCoordByLngLat: function (a, b, c) {
            ...
            this.C = !1;
            a = this.lc(a, c);
            c = new g.qr(c, Math.floor(a.x / b), Math.floor(a.y / b));
            c.cD = a.x % b;
            c.dD = a.y % b;
            return c;
        },
        ...
        getAllOverlays: function (a, b) {
            ...
            d = this.get('layers');
            e = [];
            if (d) for (var f = 0, h = d.length; f < h; f += 1) d[f] instanceof z.q.OL && e.push(d[f]), d[f].lb && (e = e.concat(d[f].lb));
            return c.concat(e);
        },
        triggerResize: function () {
            this.map && this.map.YO();
        },
        ...
        setFitView: function (a, b, c, d) {
            ...
            if ((a = this.s4(a))) {
                if ((c = this.dJ(a, 0, new g.H(40, 40), c, d))) (b = b || !this.getBounds().contains(a.yi()) || (g.l.ba && 1 < Math.abs(c[0] + this.get('zoom', null, !0)))), this.setZoomAndCenter(c[0], c[1], b);
                this.C = !1;
                return a;
            }
        },
        ...
        drawPolyline: function (a) {
            ...
            this.set('drawStyle', a || { strokeColor: '#006600', qb: 0.9 });
        },
        render: function (a) {
            g.c.add(this, 'render');
        ...
        drawPolygon: function (a) {
            ...
            this.set('drawStyle', a || { strokeColor: '#006600', qb: 0.9, fillColor: '#FFAA00', me: 0.9 });
        },
        drawCircle: function (a) {
            g.c.add(this, 'drawCircle');
            this.set('draw', 'circle');
            this.set('drawStyle', a || { strokeColor: '#006600', qb: 0.9, fillColor: '#006600', me: 0.9 });
        },
        tD: function () {
            return this.view.tD();
        },
        ...
        isForeignMapVisible: function () {
            if (this.get('gridForeignMap') || this.get('vectorForeignMap')) return this.map && this.map.zga();
        },
        Zd: function (a, b, c) {
        ...
        getObject3DByContainerPos: function (a, b, c) {
            ...
            return c
                ...
                ? (k.sort(function (a, b) {
                  ...
                  { index: k[0].index, point: k[0].mE, distance: k[0].Vd, object: k[0].object })
                : null;
        },
        gJ: function (a) {
            ...
            return b.filter(function (b) {
                return b instanceof z.q.Pm && (a ? -1 < a.indexOf(b) : !0);
            });
        },
    ...
    z.Sb.Yb({ NJ: 'lngLatToGeodeticCoord', mqa: 'geodeticCoordToLngLat', dJ: 'getFitZoomAndCenterByBounds', e4: 'getFitZoomAndCenterByOverlays', Ns: 'lnglatTocontainer', lnglatTocontainer: 'lngLatToContainer', aq: 'containTolnglat', containTolnglat: 'containerToLngLat', Cb: 'lngLatToP20', Qd: 'p20ToLngLat', Zd: 'p20ToContainer', zg: 'containerToP20', lc: 'project', Xh: 'unproject', queryObjectIndexFromFboByContainerPos: 'pickObject3DByContainerPos' });
    z.Sb.Ib({
    ...
    z.event = {
        ...
        ey: function (a, b, c, d) {
            g.a.Qh(a.ey) ? a.ey(b, c, d) : (a.we || (a.we = g.va.we), g.va.h.call(a, b, c, d, !0));
            return new g.uF(1, a, b, c, d);
        },
        mI: function (a) {
        ...
        removeListener: function (a) {
            a instanceof g.uF && (g.a.Qh(a.Bi.removeListener) ? a.Bi.removeListener(a) : 0 === a.type ? g.F.G(a.Bi, a.XQ, a.eS, a.cf) : 1 === a.type && (a.Bi.we || (a.Bi.we = g.va.we), g.va.G.call(a.Bi, a.XQ, a.eS, a.cf)));
        },
        O: function (a, b) {
    ...
    var qc = { Y: 'addDomListener', Sla: 'addDomListenerOnce', addListener: 'addListener', ey: 'addListenerOnce', mI: 'clearInstanceListeners', Ju: 'clearListeners', removeListener: 'removeListener', O: 'trigger' },
        rc;
    ...
    z.q.Zb = g.da.extend({
        ...
        setMap: function (a) {
            ...
            else if (b && (b.tk(this), this.set('map', null, !0), (this.ri = !1), this.hg && this.hg(), this.onRemove)) this.onRemove();
        },
        getMap: function () {
            g.c.add(this, 'getMap');
    ...
    z.q.sb = z.q.Zb.extend({
        w: { tileSize: 256, visible: !0, opacity: 1, zIndex: 0, noLimg: 1, zooms: [3, 20], getTileUrl: g.l.ba ? g.o.VE : g.o.QD, errorUrl: g.a.ypa, detectRetina: !0, className: 'amap-layer', mapNumber: '', merge: !1, sort: !1, cacheSize: g.l.size },
        A: function (a) {
            ...
            this.rna(a);
            var b = a.zooms;
            b && b[1] >= this.pl[0] ? (b[0] < this.pl[0] && (b[0] = this.pl[0]), b[1] > this.pl[1] && (b[1] = this.pl[1])) : (a.zooms = [this.pl[0], this.pl[1]]);
        ...
        cg: function (a) {
            ...
            if (this.Uv) return new g.q.sb(this, a, this.zr(this.A4(!0)), this.w.maxDataZoom, !0);
            if (b)
                if (((this.Hq = !0), g.q.fi)) {
                    if ('dv' === c.get('baseRender') && !this.get('watermark')) {
                        var b = c.get('showBuildingBlock'),
                            d = new g.q.sb(this, a, this.zr(this.A4(!b)), void 0, !0);
                        b && ((d.Ij = new g.q.pd(new z.q.sb({ zooms: [16, 20], innerLayer: !0 }), a, ['building'])), (d.Ij.type = '\u697c\u5757\u56fe\u5c42'), d.Ij.bf(['visible', 'opacity', 'zIndex'], d, !0), d.Ij.CC(c.get('mapStyle') || 'normal'));
                        d.type = '\u6805\u683c\u5e95\u56fe';
                        return d;
                    }
                    if ('v' <= c.get('baseRender') || this.get('watermark')) return '3D' == a.D.view.type ? ((c = new g.q.pd(this, a, ['region', 'road'])), (c.type = '\u77e2\u91cf\u5e95\u56fe'), (b = new z.q.sb({ zooms: [17, 20], zIndex: 50, innerLayer: !0 })), (c.Ij = new g.q.pd(b, a, ['building'])), (c.Ij.gf = 17), (c.Ij.type = '\u697c\u5757\u56fe\u5c42'), (c.Ij.$y = 1), c.Ij.bf(['visible', 'merge', 'sort', 'opacity'], c, !0), b.X('rejectMapMask', this, !0)) : ((c = new g.q.pd(this, a, ['region', 'building', 'road'])), (c.type = '\u77e2\u91cf\u5e95\u56fe')), (a.zma = c);
        ...
        rna: function (a) {
            ...
            g.l.ba && g.l.ja && this.w.detectRetina && !b && (this.pl[1] -= 1);
        },
        getTiles: function () {
        ...
        setTileUrl: function (a) {
            ...
            this.x2() ? (this.set('getTileUrl', a), this.ct()) : this.set('getTileUrl', a);
        },
        zr: function (a) {
            var b = this,
                c,
    ...
    z.q.sb.GW = z.q.sb.extend({
        w: { getTileUrl: g.o.zU, zooms: [3, 20], zIndex: 2, maxDataZoom: 18, detectRetina: !1, mapNumber: 'GS(2021)6342', className: 'amap-layer amap-satellite', cacheSize: g.l.size },
        A: function (a) {
    ...
    z.q.sb.DW = z.q.sb.extend({
        w: { getTileUrl: g.o.QK, zooms: [3, 20], zIndex: 3, type: 'overlayer', maxDataZoom: 18, className: 'amap-layer amap-roadnet', cacheSize: g.l.size },
        A: function (a) {
        ...
        cg: function (a) {
            if (this.get('map').Ci) {
                ...
                a = new g.q.sb(this, a, this.zr(b), this.w.maxDataZoom);
            } else (this.Hq = !1), (a = new g.q.sb(this, a));
            return a;
        },
    });
    z.q.sb.OW = z.q.sb.extend({
        ...
        cg: function (a) {
            ...
            return 'd' !== b.get('baseRender') ? (g.q.bx ? (a = new g.q.bx(this, a)) : ['vt']) : (a = new g.q.sb(this, a, null, this.w.maxDataZoom));
        },
    });
                ...
                k.Se.PE(a, d, e, function (l) {
                    if (l) h();
                        ...
                        m.src = (function (a, c, d) {
                            ...
                            return g.o.Cc + '://grid.amap.com/grid/' + d + '/' + a + '/' + c + '?src=jsapi&key=' + g.o.key + '&lang=' + e + '&dpiType=' + (g.l.Kc ? 'wprd' : 'webrd');
                        })(a, d, e);
                    }
                });
            });
    ...
    z.q.Y$ = z.q.Zb.extend({
        ...
        cg: function (a) {
            if (g.l.Yp) return (a = new g.q.Gba(this, a)), (a.$y = this.get('heightFactor') || 1), a;
        },
        setStyle: function (a) {
    ...
    z.q.GL = z.q.Zb.extend({
        ...
        getElement: function () {
            return this.q.M ? this.q.M.Pb : this.q.Cf ? this.q.Cf.Pb : null;
        },
    });
    ...
    z.q.Taa = z.q.Zb.extend({
        ...
        A: function (a, b) {
            ...
            g.c.ya(this, b);
            g.l.jl && ((this.Aj = !0), b.size && (b.size = g.a.Mq(b.size)), (this.C = !0), this.setData(a), g.a.vb(this, b), b.style ? (this.kf(this.w, !0), this.setStyle(b.style)) : this.setStyle(this.w), (this.C = !1));
        },
        clear: function () {
            g.c.add(this, 'clear');
        ...
        setStyle: function (a) {
            ...
            if (a instanceof Array) {
                ...
                this.Em = a;
            } else a.size && (a.size = g.a.Mq(a.size)), (a.rotation_ = (Math.PI * (a.rotation || 0)) / 180), this.kf(a, !0), (this.Em = { anchor: this.get('anchor'), url: this.get('url'), size: this.get('size'), rotation_: this.get('rotation_') }), (this.Em.Bf = this.Em.size.width + this.Em.anchor.x), (this.Em.jg = this.Em.size.height + this.Em.anchor.y);
            this.r('style');
        },
        setData: function (a) {
        ...
        setMap: function (a) {
            g.c.add(this, 'setMap');
            g.l.jl && (a ? (this.get('map') && this.get('map').tk(this), this.set('map', a)) : this.get('map') && (this.get('map').tk(this), this.set('map', null, !0), (this.ri = !1), this.hg && this.hg()));
        },
        cg: function (a) {
            return g.ub.KD(['cvector']) ? ((a = new g.q.gd(this, a)), this.X('datas', a), a) : ['cvector'];
        },
    });
    ...
    z.q.rr = z.q.Zb.extend({
        Haa: { visible: !0, zIndex: 121, opacity: 1, zooms: [3, 20], collision: !0, animation: !0, alwaysRender: !0 },
        w: { zooms: [3, 20] },
        qP: null,
        _markerBindArray: {},
        A: function (a) {
            ...
            if (a) {
                ...
                for (var b = 0; b < a.length; b++) {
                    ...
                    if (c) {
                        c.g = this;
                        var d = c.w,
                            e = { data: { id: c._LabelMarkerId || void 0, name: d.title || '', position: this.pfa(d.position) || void 0, rank: d.rank || void 0 }, opts: { zooms: d.zooms || void 0, opacity: 'number' === typeof d.opacity ? d.opacity : 1, zIndex: 'number' === typeof d.zIndex ? d.zIndex : 1, height: 'number' === typeof d.height ? d.height : 0, icon: {}, text: {} } };
                        if (d.icon) {
                            var f = d.icon,
                                h = f.size,
                                k = f.clipSize;
                        ...
                        d.text && ((e.opts.text = d.text), d.text.content && (e.data.txt = d.text.content), (d = (d = e.opts.text.style) && d.padding) && (e.opts.text.style.padding = this.uha(d)));
                        this.Yf.push(e);
                        this.lb.push(c);
        ...
        KU: function (a, b) {
            var c = this.qP;
            a && (b ? (c && c._LabelMarkerId !== a._LabelMarkerId && c.setTop(!1), (this.qP = a)) : (this.qP = null));
        },
        yR: function (a) {
        ...
        o4: function (a) {
            if (a) return this._markerBindArray[a] || null;
        },
        zZ: function () {
            var a = this;
        ...
        yG: function () {
            var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : [];
            return this.Jf(a.width) || this.Jf(a.height) ? (this.SZ(a) ? a.split(',') : this.Cga(a) ? [a, a] : a) : [a.width, a.height];
        },
        pfa: function () {
            var a = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : [];
            return this.Jf(a.R) || this.Jf(a.Q) ? (this.SZ(a) ? a.split(',') : a) : [a.R, a.Q];
        },
        uha: function (a) {
    ...
    z.q.OL = z.q.DA.extend({
        ...
        setMap: function (a) {
            g.c.add(this, 'setMap');
            a ? (this.get('map') && (this.get('map').tk(this), this.H2 && z.event.removeListener(this.H2), this.Y2 && z.event.removeListener(this.Y2)), this.set('map', a)) : this.get('map') && (this.get('map').tk(this), (this.De.map = null));
        },
        mapChanged: function () {
            this.get('map') && (this.get('map').RH(this), this.get('clickable') && ((this.H2 = z.event.addListener(this.get('map'), 'click', this.Pua, this)), (this.Y2 = z.event.addListener(this.get('map'), 'dblclick', this.Qua, this))));
        },
    });
    z.B.Fh = g.da.extend({
    ...
    z.B.gd = z.B.Fh.extend({
        A: function (a) {
            z.B.gd.cd.A.apply(this, arguments);
        },
        show: function () {
            g.c.add(this, 'show');
            !1 == this.get('visible', null, !0) && (this.set('visible', !0), this.r('show', { type: 'show', target: this }));
        },
        hide: function () {
            g.c.add(this, 'hide');
            !0 == this.get('visible', null, !0) && (this.set('visible', !1), this.r('hide', { type: 'hide', target: this }));
        },
        getVisible: function () {
    ...
    z.B.di = g.da.extend({
        ka: [g.va, g.$e],
        w: { size: new g.yd(36, 36), imageOffset: new g.H(0, 0), image: g.o.Hb + '/theme/v1.3/markers/0.png', imageSize: null },
        A: function (a) {
    ...
    z.B.wb = z.B.Fh.extend({
        ...
        moveAlong: function (a, b, c, d) {
            ...
            if (!(2 > a.length)) {
                a = this.Ka(a);
                for (var e = [a[0]], f = a[0], h = 1; h < a.length; h += 1) f.hb(a[h]) || (e.push(a[h]), (f = a[h]));
                this.set('move', { Of: e, speed: b, yb: c, xna: d });
            }
        },
        stopMove: function () {
        ...
        setLabel: function (a) {
            ...
            a && !g.a.vh(a) && (a = g.extend({}, this.get('label'), a));
            this.set('label', a);
        },
        getLabel: function () {
    ...
    z.B.Kaa = z.B.Fh.extend({
        ...
        S8: function () {
            var a = this.t3 || [];
            if (a.length) {
                for (var b = 0, c = a.length; b < c; b++) this.on.apply(this, a[b]);
                this.t3 = [];
            }
        },
        jJ: function () {
        ...
        getBounds: function () {
            ...
            try {
                return 'string' === typeof a ? (a = new g.U(a.split(','))) : '[object Array]' == Object.prototype.toString.apply(a) && (a = new g.U(a[0], a[1])), new g.pe(a, a.eb());
            } catch (b) {
                return null;
            }
        },
        ...
        setTop: function () {
            ...
            a ? ((this.Aca = this.w.zIndex), this.setzIndex(this.Vaa)) : this.setzIndex(this.Aca || this.w.zIndex);
        },
        getVisible: function () {
            g.c.add(this, 'getVisible');
    ...
    z.B.Un = z.B.Fh.extend({
        ...
        addItem: function (a, b, c) {
            ...
            this.get('items').push({ Rn: a, yb: b, lK: c });
            this.r('items');
        },
        ...
        close: function () {
            ...
            this.C = !0;
            this.setMap(null);
            this.map && ((this.map = this.map.uy = null), this.r('close', { type: 'close', target: this }));
            this.C = !1;
        },
    });
    z.B.Ze = z.B.Fh.extend({
        ...
        open: function (a, b, c) {
            g.c.add(this, 'open');
            b = g.a.Ka(b);
            if (a && !this.jL && (b = b || this.get('position', null, !0))) {
                this.r('change', { type: 'change', target: this });
        ...
        close: function () {
            g.c.add(this, 'close');
            this.B && this.B.map && ((this.C = !0), this.setMap(null), (this.map = null), this.r('change', { type: 'change', target: this }), (this.C = !1));
        },
        getAnchor: function () {
            g.c.add(this, 'getAnchor');
            return this.get('anchor', null, !0);
        ...
        getSize: function (a) {
            ...
            if (b) return b;
            if (this.B && !a) return new g.yd(this.B.qh.offsetWidth, this.B.qh.offsetHeight);
        },
        getIsOpen: function () {
    ...
    z.B.$b = z.B.fM.extend({
        ...
        getLength: function () {
            ...
            for (var a = this.get('path'), b = 0, c = 0; c < a.length - 1; c += 1) b += a[c].He(a[c + 1]);
        ...
        a.Mw = {
                        ...
                        if (0 === b) b = 0;
                            ...
                            if (0.001 <= l) {
                                ...
                                var d = c,
                                    ...
                                    m,
                                    n = 0;
                                do (m = d + (c - d) / 2), (l = a(m, e, h) - b), 0 < l ? (c = m) : (d = m);
            ...
            j4: function (a, b, c, d) {
                var e,
                    ...
                    r = [];
                e = 0;
                for (f = a.length; e < f; e += 1) r.push.apply(r, h(a[e - 1], a[e], a[e].controlPoints, b, c, d));
                return r;
            },
    ...
    z.B.uA = z.B.$b.extend({
        ...
        getInterpolateLngLats: function () {
            ...
            var a = this.get('map');
            return g.Mw.Uqa(this.get('path'), (a && a.nj) || g.$h.KL, Math.pow(2, 2), this.w);
        },
        getSerializedPath: function () {
            ...
            for (var a = this.get('path', null, !0), b = [], c = 0, d = a.length; c < d; c++) {
                ...
                if (e instanceof g.U) {
                    var f = [];
                    if (e.controlPoints) for (var h = 0, k = e.controlPoints.length; h < k; h++) f.push(e.controlPoints[h].CR()), f.push(e.controlPoints[h].zR());
                    f.push(e.CR());
                    f.push(e.zR());
                    b.push(f);
                } else b.push(e);
        ...
        Bja: function (a) {
            ...
            if (a instanceof g.U) b = a;
                ...
                } else if (g.a.isArray(a[0])) for (d = a.length, b = new g.U(a[d - 1][0], a[d - 1][1]), c = 0, d -= 1; c < d; c++) e.push(new g.U(a[c][0], a[c][1]));
    ...
    z.B.Ec = z.B.fM.extend({
        ...
        y4: function (a) {
            var b = (6378137 * Math.PI) / 180,
                ...
                d = a.length;
            if (3 > d) return 0;
            for (var e = 0; e < d - 1; e += 1) var f = a[e], h = a[e + 1], k = f.R * b * Math.cos((f.Q * Math.PI) / 180), f = f.Q * b, l = h.R * b * Math.cos((h.Q * Math.PI) / 180), c = c + (k * h.Q * b - l * f);
            e = a[e];
            a = a[0];
        ...
        getArea: function () {
            ...
            for (var a = this.get('path', null, !0), a = this.dK(a), b = 0, c = 0, d = a.length; c < d; c += 1) for (var e = a[c], b = b + this.y4(e[0]), f = 1; f < e.length; f += 1) b -= this.y4(e[f]);
        ...
        getBounds: function () {
            var a = this.get('path');
            if (a && a.length) {
                for (var a = this.dK(a), b = new g.pe(180, 90, -180, -90), c = 0, d = a.length; c < d; c += 1) for (var e = a[c][0], f = e.length - 1; 0 <= f; f -= 1) b.extend(e[f]);
                return b;
            }
            return null;
        },
        contains: function (a) {
            ...
            for (var c = 0, d = b.length; c < d; c += 1) {
                for (var e = b[c], f = !1, h = 0, k = e.length; h < k && ((f = this.fna(e[h])), g.xd.vq(f) || f.reverse(), (f = g.xd.Ud(a, f, 0 === h ? !0 : !1)), 0 < h && (f = !f), f); h += 1);
                if (f) return !0;
            }
            return !1;
        },
    ...
    z.B.hh = z.B.gd.extend({
        ...
        setCenter: function (a, b) {
            g.c.add(this, 'setCenter');
            (a = g.a.Ka(a)) && a instanceof g.U && (this.B && this.B.get('deltaPos') && this.B.set('deltaPos', [0, 0], !0), this.set('center', a), this.r('change', { type: 'change', target: this }), this.ah || ((this.ah = !0), this.get('map') && this.get('map').r('overlays')), b || this.r('setCenter'));
        },
        getCenter: function () {
            g.c.add(this, 'getCenter');
            var a = this.get('center', null, !0);
            this.B && this.B.get('deltaPos') && (a = this.B.Ut([a], this.B.get('deltaPos'))[0]);
            return a;
        },
        reset: function () {
            var a = this.get('center', null, !0);
    ...
    z.B.XV = z.B.hh.extend({
        ...
        contains: function (a) {
            ...
            b.C = !0;
            var d = !1;
            c.He(a) <= this.get('radius') * b.getResolution(c) && (d = !0);
            b.C = !1;
            return d;
        },
    });
    ...
    g.Pa = sc;
    g.Pa.Yb({ Mf: 'dot', eb: 'clone', add: 'add', sub: 'sub', bma: 'addVectors', Xz: 'subVectors', yy: 'crossVectors', normalize: 'normalize', length: 'length' });
    var vc = g.da.extend({
        A: function (a) {
            var b = Array(4),
                c;
    ...
    function yc(a, b, c, d, e, f) {
        this.kE = [void 0 !== a ? a : new g.Xw(), void 0 !== b ? b : new g.Xw(), void 0 !== c ? c : new g.Xw(), void 0 !== d ? d : new g.Xw(), void 0 !== e ? e : new g.Xw(), void 0 !== f ? f : new g.Xw()];
    }
    g.gW = yc;
    yc.prototype = {
    ...
    (function (a) {
        ...
        b.prototype.set = function (a) {
            if (a.elements !== this.elements) return (this.elements = a.elements.slice(0)), this;
        };
        ...
        b.prototype.Tz = function (a, b, e, f) {
            ...
            a = Math.cos(a);
            0 !== b && 0 === e && 0 === f
                ? (0 > b && (k = -k), (h[0] = 1), (h[4] = 0), (h[8] = 0), (h[12] = 0), (h[1] = 0), (h[5] = a), (h[9] = -k), (h[13] = 0), (h[2] = 0), (h[6] = k), (h[10] = a), (h[14] = 0), (h[3] = 0), (h[7] = 0), (h[11] = 0))
                : 0 === b && 0 !== e && 0 === f
                ? (0 > e && (k = -k), (h[0] = a), (h[4] = 0), (h[8] = k), (h[12] = 0), (h[1] = 0), (h[5] = 1), (h[9] = 0), (h[13] = 0), (h[2] = -k), (h[6] = 0), (h[10] = a), (h[14] = 0), (h[3] = 0), (h[7] = 0), (h[11] = 0))
                : 0 === b && 0 === e && 0 !== f
                ? (0 > f && (k = -k), (h[0] = a), (h[4] = -k), (h[8] = 0), (h[12] = 0), (h[1] = k), (h[5] = a), (h[9] = 0), (h[13] = 0), (h[2] = 0), (h[6] = 0), (h[10] = 1), (h[14] = 0), (h[3] = 0), (h[7] = 0), (h[11] = 0))
                : ((l = Math.sqrt(b * b + e * e + f * f)), 1 !== l && ((l = 1 / l), (b *= l), (e *= l), (f *= l)), (l = 1 - a), (m = b * e), (n = e * f), (p = f * b), (q = b * k), (r = e * k), (k *= f), (h[0] = b * b * l + a), (h[1] = m * l + k), (h[2] = p * l - r), (h[3] = 0), (h[4] = m * l - k), (h[5] = e * e * l + a), (h[6] = n * l + q), (h[7] = 0), (h[8] = p * l + r), (h[9] = n * l - q), (h[10] = f * f * l + a), (h[11] = 0), (h[12] = 0), (h[13] = 0), (h[14] = 0));
            h[15] = 1;
            return this;
        };
        ...
        b.prototype.$u = function (a) {
            for (var b = 0, e = this.elements.length; b < e; b++) if (this.elements[b] !== a.elements[b]) return !1;
            return !0;
        };
    ...
    z.B.Gt = z.B.Ec.extend({
        ...
        Vr: function () {
            ...
            if (c && d)
                for (
                    var c = g.a.Ka(c),
                        e = a.radius || this.get('radius'),
                        f = d.Cb(c),
                        a = f.x,
                        f = f.y,
                        h = g.a.map(e, function (a) {
                    ...
                    var n = m * l,
                        n = { x: a + e * Math.cos(n), y: f + h * Math.sin(n) };
                    b.push(d.Qd(n));
                }
            return b;
        },
        mapChanged: function () {
            ...
            this.C = !0;
            this.setPath(this.Vr());
            this.C = !1;
            !this.ah && this.get('map') && ((this.ah = !0), this.get('map').r('overlays'));
        },
        setCenter: function (a, b) {
            g.c.add(this, 'setCenter');
            (a = g.a.Ka(a)) && a instanceof g.U && (this.B && this.B.get('deltaPos') && this.B.set('deltaPos', [0, 0], !0), this.set('center', a), this.set('path', this.Vr()), this.ah || ((this.ah = !0), this.get('map') && this.get('map').r('overlays')), b || (this.r('setCenter'), this.r('change', { type: 'change', target: this })));
        },
        setRadius: function (a) {
            var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : !1;
            g.c.add(this, 'setRadius');
            a && 2 === a.length && (this.set('radius', a), this.set('path', this.Vr()), b || (this.r('change', { type: 'change', target: this }), this.r('setPath')));
        },
        setOptions: function (a) {
    ...
    z.B.Nt = z.B.Ec.extend({
        ...
        mapChanged: function () {
            g.a.Qh(z.B.Nt.cd.mapChanged) && z.B.Nt.cd.mapChanged.apply(this);
            this.C = !0;
            this.setPath(this.Vr());
            this.C = !1;
            !this.ah && this.get('map') && ((this.ah = !0), this.get('map').r('overlays'));
        ...
        setBounds: function (a) {
            var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : !1;
            g.c.add(this, 'setBounds');
            a && a instanceof g.pe && (this.set('bounds', a), this.set('path', this.Vr()), this.ah || ((this.ah = !0), this.get('map') && this.get('map').r('overlays')), b || (this.r('change', { type: 'change', target: this }), this.r('setBounds')));
        },
        getBounds: function () {
            g.c.add(this, 'getBounds');
    ...
    z.B.Xn.Yb({ find: 'getOverlay', ZI: 'getOverlays', uC: ['addOverlay', 'addOverlays'], Nd: 'hasOverlay', Lz: ['removeOverlay', 'removeOverlays'], ld: 'clearOverlays', Ub: 'eachOverlay', vc: 'setMap', vb: 'setOptions', show: 'show', az: 'hide', h: 'on', G: 'off' });
    (function (a, b) {
        function c(a, b) {
        ...
        a.B.hW = a.B.Xn.extend({
            ...
            $ca: function (c) {
                for (var d = 'Feature' === c.type ? c.geometry : c, d = d ? d.coordinates : null, e = [], f = 0, n = d.length; f < n; f++) e.push(this.FX(b.extend({}, c, { type: 'Feature', properties: { _isAmap: !0, _pointIndex: f, _parentProperities: c.properties }, geometry: { type: 'Point', coordinates: d[f] } })));
                d = new a.B.Xn(e);
                this.Mr(c, d);
                return d;
            },
            ...
            Zca: function (c) {
                for (var d = 'Feature' === c.type ? c.geometry : c, d = d ? d.coordinates : null, e = [], f = 0, n = d.length; f < n; f++) e.push(this.EX(b.extend({}, c, { type: 'Feature', properties: { _isAmap: !0, _lineStringIndex: f, _parentProperities: c.properties }, geometry: { type: 'LineString', coordinates: d[f] } })));
                d = new a.B.Xn(e);
                this.Mr(c, d);
                return d;
            },
            ...
            ada: function (c) {
                for (var d = 'Feature' === c.type ? c.geometry : c, d = d ? d.coordinates : null, e = [], f = 0, n = d.length; f < n; f++) e.push(this.GX(b.extend({}, c, { type: 'Feature', properties: { _isAmap: !0, _polygonIndex: f, _parentProperities: c.properties }, geometry: { type: 'Polygon', coordinates: d[f] } })));
                d = new a.B.Xn(e);
                this.Mr(c, d);
                return d;
            },
            Tca: function (c) {
                for (var d = ('Feature' === c.type ? c.geometry : c).geometries, e = [], f = 0, n = d.length; f < n; f++) e.push(this.ON(b.extend({}, c, { type: 'Feature', properties: { _isAmap: !0, _geometryIndex: f, _parentProperities: c.properties }, geometry: d[f] })));
                d = new a.B.Xn(e);
                this.Mr(c, d);
                return d;
            },
        ...
        a.B.Ec.Ib({
            toGeoJSON: function () {
                ...
                if (b.a.isArray(c[0]) && b.a.isArray(c[0][0])) {
                    ...
                    return { type: 'Feature', properties: a._geoJsonProperties || {}, geometry: { type: 'MultiPolygon', coordinates: d } };
                }
    ...
    z.q.TL.Yb({ find: 'getLayer', ZI: 'getLayers', RH: ['addLayer', 'addLayers'], Nd: 'hasLayer', tk: ['removeLayer', 'removeLayers'], Cna: 'clearLayers', Ub: 'eachLayer', vc: 'setMap', vb: 'setOptions', show: 'show', az: 'hide', reload: 'reload', h: 'on', G: 'off' });
    g.aba = z.Sb.extend({
        A: function (a, b) {
    ...
    g.xd = {
        ns: function (a, b) {
            for (var c = Infinity, d = 0, e = 1, f = b.length; e < f; d = e, e += 1) c = Math.min(c, g.xd.Yxa(a, [b[d], b[e]]));
            return Math.sqrt(c);
        },
        Yxa: function (a, b) {
        ...
        S7: function (a, b) {
            ...
            for (var m = 0, n = b.length - 1; m < n; m++) {
                ...
                var p = l,
                    l = [];
                h = p[p.length - 1];
                for (var q = 0, r = p.length; q < r; q++) (k = p[q]), d(k, e, f) ? (d(h, e, f) || l.push(c(e, f, h, k)), l.push(k)) : d(h, e, f) && l.push(c(e, f, h, k)), (h = k);
                e = f;
            }
    ...
    (function (a) {
        ...
        function d(a) {
            for (var b = 0, c = a.length, d = 0; d < c - 1; d++) var e = a[d], n = a[d + 1], b = b + (n[0] - e[0]) * (n[1] + e[1]);
        ...
        a.extend(e.prototype, {
            ...
            closestOnSegment: function (b, c, d) {
                b = a.xd.I2(this.project(b), this.Hx([c, d]));
            ...
            isPointInRing: function (b, c, d) {
                ...
                c = this.Hx(c, !0);
                return a.xd.Ud(this.project(b), c, !1);
            },
            ...
            doesSegmentsIntersect: function (a, b, c, d, e) {
                e = e ? [a, b, c, d] : this.Hx([a, b, c, d]);
                a = e[0];
                b = e[1];
                c = e[2];
                d = e[3];
            ...
            doesRingRingIntersect: function (a, b, c) {
                ...
                for (var d = 0, e = a.length; d < e; d++) if (this.doesSegmentRingIntersect(a[d], a[d === e - 1 ? 0 : d + 1], b, c)) return !0;
                return !1;
            },
            GP: function (a, b) {
    ...
    (function (a) {
        a.tF = function () {
            function a(b, c, d, e, f) {
                ...
                if (f === 0 < k) for (f = c; f < d; f += e) h = r(f, b[f], b[f + 1], h);
                else for (f = d - e; f >= c; f -= e) h = r(f, b[f], b[f + 1], h);
            ...
            function d(a, b, e, f, r, u, C) {
                if (a) {
                    if (!C && u) {
                        var D = a,
                            A = D;
                        do null === A.z && (A.z = h(A.x, A.y, f, r, u)), (A.kp = A.Ia), (A = A.ol = A.next);
                        while (A !== D);
                        A.kp.ol = null;
                        A.kp = null;
                        var D = A,
                        ...
                        do {
                            ...
                            for (I = 0; A; ) {
                                ...
                                for (L = M; 0 < P || (0 < L && G); ) 0 !== P && (0 === L || !G || A.z <= G.z) ? ((B = A), (A = A.ol), P--) : ((B = G), (G = G.ol), L--), H ? (H.ol = B) : (D = B), (B.kp = H), (H = B);
                                A = G;
                            }
                            H.ol = null;
                            M *= 2;
                    ...
                    for (D = a; a.Ia !== a.next; ) {
                        ...
                        G = a.next;
                        if (u)
                            a: if (((H = a.Ia), (I = a.next), 0 <= l(H, a, I))) H = !1;
                            else {
                        ...
                        if (H) b.push(A.xe / e), b.push(a.xe / e), b.push(G.xe / e), s(a), (D = a = G.next);
                        else if (((a = G), a === D)) {
                            if (C)
                                if (1 === C) {
                                    C = b;
                                    D = e;
                                    A = a;
                                    do (G = A.Ia), (H = A.next.next), !m(G, H) && n(G, A, A.next, H) && p(G, H) && p(H, G) && (C.push(G.xe / D), C.push(A.xe / D), C.push(H.xe / D), s(A), s(A.next), (A = a = H)), (A = A.next);
                                    while (A !== a);
                                    a = A;
                                    d(a, b, e, f, r, u, 2);
                                } else {
                                                        ...
                                                        if (((A = void 0), (A = C.next.xe !== D.xe)))
                                                            if (((A = void 0), (A = C.Ia.xe !== D.xe))) {
                                                                ...
                                                                b: {
                                                                    A = C;
                                                                    do {
                                                                        if (A.xe !== C.xe && A.next.xe !== C.xe && A.xe !== D.xe && A.next.xe !== D.xe && n(A, A.next, C, D)) {
                                                                            A = !0;
                                                                            break b;
                                                                        }
                                                                        A = A.next;
                                                                ...
                                                                if ((A = !A))
                                                                    if (((A = void 0), (A = p(C, D))))
                                                                        if (((A = void 0), (A = p(D, C)))) {
                                                                            ...
                                                                            H = (C.x + D.x) / 2;
                                                                            I = (C.y + D.y) / 2;
                                                                            do A.y > I !== A.next.y > I && A.next.y !== A.y && H < ((A.next.x - A.x) * (I - A.y)) / (A.next.y - A.y) + A.x && (G = !G), (A = A.next);
                                                                            while (A !== C);
                                                                            A = G;
                                                                        }
                                                            }
            ...
            function u(a, b, c) {
                ...
                this.x = b;
                this.y = c;
                this.ol = this.kp = this.z = this.next = this.Ia = null;
                this.w9 = !1;
            }
            return {
                nL: function (h, k, l) {
                    ...
                    if (h.length > 80 * l) {
                        s = B = h[0];
                        u = m = h[1];
                        for (H = l; H < n; H += l) (G = h[H]), (k = h[H + 1]), G < s && (s = G), k < u && (u = k), G > B && (B = G), k > m && (m = k);
                        B = Math.max(B - s, m - u);
                        B = 0 !== B ? 1 / B : 0;
                    }
                    d(p, r, l, s, u, B);
    ...
    (function (a) {
        ...
        a.$n = {
            ...
            normalize: function (b) {
                ...
                if (b) {
                    c = [];
                    for (var f = 0, h = b.length; f < h; f += 1) c[f] = b[f] instanceof Array ? this.normalize(b[f]) : b[f] instanceof a.U ? [b[f].R, b[f].Q] : b[f] instanceof a.H ? [b[f].x, b[f].y] : b[f];
                }
                return c;
            },
            Wh: function (d, e) {
    ...
    g.sI = function (a, b, c) {
        ...
        var d = g.o.Ed + '/v3/assistant/coordinate/convert';
        a = g.a.Ka(a);
        var e = [];
        if (a instanceof Array) {
            ...
            if (!this.w.iy || !this.lna()) {
                ...
                window[f] = function (a) {
                    ...
                    if (k.w.callbackFunction) k.w.callbackFunction.call(k.w.context, a);
                        ...
                        (g.a.R8 = !0),
                            g.ub.load('AMap.AntiCrabFrame', function () {
                                g.a.iy || (g.a.iy = new g.T$());
                                g.a.eL.push(k);
                                g.a.iy.open(k.w.Gd, a.data.host, k.hE || '', k.url);
                            });
                    else {
                ...
                if (-1 !== a.indexOf(g.o.Ed + '/v') || -1 !== a.indexOf('yuntuapi.amap.com/datasearch') || -1 !== a.indexOf('webapi.amap.com/')) (b = b + '&platform=JS&logversion=2.0' + ('&appname=' + g.o.Ao)), (b += '&csid=' + g.a.Dw()), (b += '&sdkversion=' + g.o.Xl);
                if ((c = this.w.II)) {
                    var l = [],
                        m;
                ...
                g.kb.Ab.kea = document.getElementsByTagName('body')[0] || document.getElementsByTagName('head')[0];
        ...
        send: function (a, b, c, d, e) {
            ...
            if ((g.l.Ve || g.l.l5) && window.XDomainRequest) {
                ...
                k.onreadystatechange = function () {
                    4 === k.readyState && 200 === k.status ? f.r('complete', { url: a, data: 'arraybuffer' === k.responseType || 'json' === k.responseType ? k.response : k.responseText }) : 404 === k.status && (k.abort(), f.r('error', { url: a, data: '404' }));
                };
    ...
    for (
        var $ = { v: '1.4.18', Pixel: g.H, LngLat: g.U, Size: g.yd, Bounds: g.pe, ArrayBounds: g.vp, PixelBounds: g.Xf, Panorama: g.aba, PanoramaMarker: g.bba, Map: z.Sb, View2D: z.PF, GroundImage: z.q.OL, Marker: z.B.wb, ImageMarker: z.B.IAa, Text: z.B.MW, Icon: z.B.di, MarkerShape: z.B.Raa, Polyline: z.B.$b, BezierCurve: z.B.uA, Polygon: z.B.Ec, Circle: z.B.hh, CircleMarker: z.B.XV, Ellipse: z.B.Gt, Rectangle: z.B.Nt, ContextMenu: z.B.Un, InfoWindow: z.B.Ze, Buildings: z.q.Y$, TileLayer: z.q.sb, ImageLayer: z.q.DA, CanvasLayer: z.q.$$, VideoLayer: z.q.Iba, VectorLayer: z.q.gd, MassMarks: z.q.Taa, CompositeLayer: z.q.daa, LabelsLayer: z.q.rr, LabelMarker: z.B.Kaa, LayerGroup: z.q.TL, OverlayGroup: z.B.Xn, GeoJSON: z.B.hW, CANVAS: 'canvas', DOM: 'dom', convertFrom: g.sI, Http: { JSONP: g.kb.Ab }, event: { CLASS_NAME: 'AMap.event' } }, Ic = 'addDomListener addDomListenerOnce addListener addListenerOnce clearInstanceListeners clearListeners removeListener trigger'.split(' '), Jc = 0;
        Jc < Ic.length;
        Jc += 1
    )
        $.event[Ic[Jc]] = (function () {
            var a = g.event[Ic[Jc]],
                b = Ic[Jc];
            return function () {
                g.c.ya($.event);
    ...
    for (Jc = 0; Jc < Kc.length; Jc += 1)
        $.PlaneGeometryUtil[Kc[Jc]] = (function () {
            var a = g.ei[Kc[Jc]],
                b = Kc[Jc];
            return function () {
    ...
    $.UA = { ie: g.l.Gs, ielt9: g.l.Ve, ielt11: g.l.bsa, mobile: g.l.ba, android: g.l.Zl, ios: g.l.GD };
    $.Browser = {
    ...
    var Lc = { colorNameToHex: g.a.nI, rgbHex2Rgba: g.a.D8, argbHex2Rgba: g.a.Sr, isEmpty: g.a.vh, deleteItemFromArray: g.a.Cy, deleteItemFromArrayByIndex: g.a.Ho, indexOf: g.a.indexOf, format: g.a.xb, isArray: g.a.isArray, isDOM: g.a.GJ, includes: g.a.ka, requestIdleCallback: g.a.sU, cancelIdleCallback: g.a.bQ, requestAnimFrame: g.a.Xc, cancelAnimFrame: g.a.si, color2RgbaArray: g.a.am, color2Rgba: g.a.Qna };
    for (Jc in Lc)
        Lc.hasOwnProperty(Jc) &&
            'function' == typeof Lc[Jc] &&
            ($.Util[Jc] = (function () {
                var a = Jc;
                return function () {
                    g.c.ya($.Util);
    ...
    var Mc = { getViewport: g.f.nJ, getViewportOffset: g.f.TR, create: g.f.create, setClass: g.f.uxa, hasClass: g.f.An, addClass: g.f.Wa, removeClass: g.f.fb, setOpacity: g.f.Yq, rotate: g.f.rotate, setCss: g.f.ab, empty: g.f.Kz, remove: g.f.remove, TRANSFORM: g.f.qg, TRANSITION: g.f.LF };
    for (Jc in Mc)
        Mc.hasOwnProperty(Jc) &&
            'function' == typeof Mc[Jc] &&
            ($.DomUtil[Jc] = (function () {
                var a = Jc;
                return function () {
                    g.c.ya($.DomUtil);
    ...
    g.Lj = g.da.extend({
        ...
        update: function () {
            ...
            'number' === typeof b && Math.abs(b - this.end) < this.precision ? (this.stop(), (b = this.end)) : (this.zo = g.a.Xc(this.update));
            this.ih = a;
            this.Sia(b);
        },
        stop: function (a) {
    ...
    g.Sb = g.da.extend({
        ...
        A: function (a, b) {
            ...
            g.o.TQ && this.Cd ? this.X('style', b, !0) : this.X('styleUrl', b);
            this.X('hightlight', b, !0);
            this.X('labelzIndex', b, !0);
            if (g.l.dL) {
                c = new z.q.sb({ innerLayer: !0, zIndex: b.get('labelzIndex'), visible: !1 });
                this.Hc = new g.q.Qj(c, this, ['point', 'road']);
                this.Hc.type = '\u77e2\u91cf\u6807\u6ce8';
                var d = this.D.get('defaultLayer');
                d && c.X('rejectMapMask', d, !0);
                b.labelsLayer = this.Hc.S;
                this.Hc.S.h('complete', this.Cr, this, !0);
                this.Hc.S.h('renderComplete', this.Cr, this);
            ...
            this.bf('rotateEnable pitchEnable dragEnable keyboardEnable doubleClickZoom scrollWheel zoomEnable touchZoom'.split(' '), b, !0);
            this.get('jogEnable') ? (this.xv = !0) : (this.xv = !1);
            this.mga();
            this.tga();
            this.GG && this.GG();
        ...
        styleUrlChanged: function () {
            if (this.D.Ci) {
                ...
                if (a !== this.Dm) {
                    ...
                    if ('normal' === c) (this.Dm = ''), this.set('nolimg', !!this.D.get('nolimg_param')), this.set('style', ''), (this.Pu = '');
                    else {
                        this.jA = !0;
                        this.set('nolimg', !0);
                        var d;
                        32 > c.length ? (d = g.o.Cc + '://webapi.amap.com/style2?name=' + c + '&key=' + g.o.key) : ((d = g.o.Cc + '://webapi.amap.com/v4/map/styles2?styleid=' + c + '&s=rsv3&key=' + g.o.key + (b ? '&ispublic=1' : '')), g.o.Xa ? (d += '&jscode=' + g.o.Xa) : g.o.ys && (d = g.o.ys + '/v4/map/styles2?styleid=' + c + '&s=rsv3&key=' + g.o.key + (b ? '&ispublic=1' : '')));
        ...
        nna: function () {
            ...
            if (!a.contains(b)) {
                ...
                a.uj() < b.uj() ? (c.Q = a.yi().Q) : (a.wc.Q > b.wc.Q && (c.Q += a.wc.Q - b.wc.Q), a.oc.Q < b.oc.Q && (c.Q += a.oc.Q - b.oc.Q));
                return c;
            }
        },
        YO: function () {
            ...
            this.D.refreshSize();
            var b = this.get('size');
            b && a && !b.hb(a) && ((this.QU = b), (this.jt = !0), this.set('display'), this.A8(b), this.get('resizeEnable') && this.qa('resize', { Eua: a, U6: b }));
        },
        o0: function () {
            var a = this;
            a.YO();
        ...
        vsa: function () {
            ...
            b.Yr = g.f.create('div', b.ad, 'amap-drags');
            b.q = g.f.create('div', b.Yr, 'amap-layers');
            b.B = g.f.create('div', b.Yr, 'amap-overlays');
            ...
            350 < g.f.nJ(this.K).width && ((b.sn.innerHTML = this.D.w.copyright), (b.sn.x6 = g.f.create('span', b.sn, 'amap-mcode')), this.vE());
            this.Ya = b;
        },
        vE: function () {
            ...
            if (a) {
                ...
                this.D.C = !1;
                'GS(2021)6375' === c && a && 'normal' !== a && 'amap://styles/normal' !== a && ((c = ''), (this.Ya.sn.style.visibility = 'hidden'));
                c && this.Ya.sn.x6 && ((this.Ya.sn.x6.innerHTML = '- ' + c + '\u53f7'), (this.Ya.sn.style.visibility = 'visible'));
                return c;
            }
        },
        BY: function () {
        ...
        eU: function (a) {
            ...
            c &&
                (this.D.set('rasterLayer', void 0),
                (this.D.f8 = !0),
                (this.D.Uv = this.D.Ra),
                this.wi && (this.wi.xD = !1),
                c.q && (c.q.ZD = !0),
                a ||
                    (this.fU = g.a.sU(function () {
                        b.fU = null;
                        b.D && b.D.tk(c);
                    })));
        ...
        Cr: function () {
            function a() {
                for (var a = d.get('layers'), b = d.get('zoom'), c = 0; c < a.length; c += 1) {
                    var e = a[c].get('zooms');
                    if (!(a[c].Aj || a[c].Uv || a[c].u5 || !e || b > e[1] || b < e[0] || !a[c].get('visible') || (a[c].q && a[c].q.ha && 0 === a[c].q.ha.length) || (a[c].q && a[c].q.ZD) || (a[c].q && a[c].q.Ra))) return !1;
                }
                a = d.D.get('features');
            ...
            if (!this.xI)
                if (this.PS) this.BY();
                    ...
                    var d = this,
                        ...
                        f = a();
                    e ? (e.q && e.q.Ra && (this.D.Ra || c()), f && (this.D.Ra || c(), this.eU(), b())) : f && (this.D.Ra || c(), b(), (this.D.f8 = !0));
                }
        },
        layersChanged: function () {
            this.la = this.la || [];
            for (var a = this.get('layers'), b = this.la.length - 1; 0 <= b; b -= 1) this.la[b] === this.ud || this.la[b] === this.at || this.la[b].AB || this.la[b].S.AB || -1 !== g.a.indexOf(a, this.la[b].S) || (this.la[b].hg(), this.la[b].Ij && this.la[b].Ij.hg(), this.la[b].S.G('complete', this.Cr, this), this.la[b].S.G('renderComplete', this.Cr, this), (this.la = g.a.Ho(this.la, b)));
            for (var c = !1, d = !0, e = this.get('labelzIndex'), b = 0; b < a.length; b += 1)
                if (!a[b].u5)
                    if (a[b].ri) -1 === g.a.indexOf(this.la, a[b].q) && this.la.push(a[b].q);
                        ...
                        a[b].h('complete', this.Cr, this, !0);
                        a[b].h('renderComplete', this.Cr, this);
                    }
            for (b = 0; b < this.la.length; b += 1) (f = this.la[b].S), f.Hq && f.get('visible') && ((c = !0), !1 === f.get('detectRetina') && (d = !1), (e = f.get('textIndex') || e));
            this.Hc &&
                (c || '3D' !== this.D.view.type
                    ? (this.Hc.qo = !1)
                    : ((c = g.a.find(a, function (a) {
                          if (z.q.Jt && a instanceof z.q.Jt && a.get('visible')) return !0;
                      })),
                      (this.Hc.qo = c = !!c)));
            a = g.a.indexOf(this.la, this.Hc);
            c && this.D.get('showLabel') ? (-1 === a && this.la.push(this.Hc), (this.Hc.ja = d && g.l.ja), this.Hc.CC(this.get('mapStyle') || 'normal'), this.Hc.set('zIndex', e), this.Hc.set('visible', !0), (this.D.wD = !0), this.D.get('isHotspot') ? this.Hc.Xua() : this.Hc.kQ()) : (this.Hc && (this.Hc.set('visible', !1), (this.D.wD = !1), this.Hc.kQ()), (this.D.wD = !1));
        ...
        controlsChanged: function () {
            var a = this.get('controls'),
                b,
                c;
            if (a.add && 0 < a.add.length) for (; 0 < a.add.length; ) (b = a.add.shift()), (c = b.zu || b.addTo) && c.call(b, this.D, this.Ya.controls);
            else if (a.remove && a.remove.length) for (; 0 < a.remove.length; ) (b = a.remove.shift()), (c = b.Wv || b.removeFrom) && c.call(b, this.D, this.Ya.controls);
        },
        B1: function () {
            if (!this.xI) {
                var a = this;
                this.G1 = !1;
                a.ud || ((a.ud = new g.q.gd(new z.q.gd(), a)), (a.ud.Bf = 36), (a.ud.jg = 36), a.ud.set('zIndex', 120), a.la.push(a.ud), (a.ud.YC = !0));
                for (var b = a.get('overlays'), c = [], d = 0; d < a.Wc.length; d += 1) -1 === g.a.indexOf(b, a.Wc[d].Mb) && (a.Wc[d].Mb instanceof z.B.Ze || a.Wc[d].Mb instanceof z.B.Un ? a.Wc[d].hg() : (a.ud && a.Wc[d] instanceof g.B.wb ? ((a.ud.bh = g.a.Cy(a.ud.bh, a.Wc[d].L)), a.ud.m8([a.Wc[d].L])) : a.at && a.at.m8([a.Wc[d].L]), a.Wc[d].L.fa ? (g.f.remove(a.Wc[d].L.fa), (a.Wc[d].L.fa = null)) : a.Wc[d].L.Ma && (g.f.remove(a.Wc[d].L.Ma.Ph), g.f.remove(a.Wc[d].L.Ma.Rc), g.f.remove(a.Wc[d].L.Ma.dir), (a.Wc[d].L.Ma = null)), a.Wc[d].Hn && a.Wc[d].Hn.stop(), a.Wc[d].zh && a.Wc[d].zh.stop(), (a.Wc[d].Mb.ri = !1), a.Wc[d].Mb.zl(), (a.Wc[d].Mb.B = null), (a.Wc[d].Mb = null), a.Wc[d].L.Uoa(), (a.Wc[d].L = null), a.Wc[d].zl(), (a.Wc[d].De = null), a.Wc[d].ui(), (a.Wc[d].map = null)), c.push(a.Wc[d]));
                ...
                g.a.pxa(function (b) {
                    if (!b.ri && b.ah) {
                        var c = b.B || a.Tma(b);
                        c && (a.Wc.push(c), c instanceof g.B.Ze || c instanceof g.B.Un ? c.Vs(a) : c instanceof g.B.wb ? e.push(c.L) : f.push(c.L), (b.ri = !0));
                    }
                }, b);
                e.length && a.ud.cy(e);
                f.length && (a.at || ((a.at = new g.q.gd(new z.q.gd(), a)), a.at.set('zIndex', 110), a.la.push(a.at)), a.at.cy(f));
                a.set('display', 0);
            }
        },
        overlaysChanged: function () {
            this.Wc = this.Wc || [];
            this.get('overlays') && 0 === this.get('overlays').length ? this.B1() : this.G1 || (g.a.Xc(this.B1, this), (this.G1 = !0));
        },
        ...
        P3: function () {
            var a = this.Ee;
            this.Pu && (!this.Se || !this.Se.Jp || (this.D && this.D.ks)) && (a = 'function' === typeof this.Pu ? this.Pu(this.wi.P.zoom) : this.Pu);
            return a;
        },
        LCa: function () {
            function a() {}
            ...
            for (var e = 0; 100 > e; e += 1)
                for (var f = 0; 100 > f; f += 1) {
                    var h = new g.U(d.R + 0.02 * f, d.Q + 0.02 * e),
                        h = new g.bi({ name: 'point' + (100 * e + f), map: this, W: new g.Aa.Ng(this.Cb(h)) });
                    c[100 * e + f] = h;
                    h.h('hover', a, h);
                }
            b.cy(c);
        ...
        NK: function (a) {
            ...
            else this.Fw || ((this.zE = g.a.Xc(this.pc)), (this.Fw = !0));
        },
        pc: function () {
            this.zE = null;
            if (!this.xI) {
                ...
                if (this.la && ((a.size = this.D.get('size')), a.size.width && a.size.height)) {
                    ...
                    c.sort(function (a, b) {
                        var c = a.get('zIndex'),
                            d = b.get('zIndex');
                        return c > d ? 1 : c === d ? (a.gx > b.gx ? 1 : -1) : -1;
                    });
                    a.la = c;
                    ...
                    a.tua = !0;
                    a.YH = this.YH;
                    for (var b = !1, f, c = !1, d = 0; d < this.la.length; d += 1) this.la[d].Ei && this.la[d].S.get('visible') && a.P.zoom <= this.la[d].S.get('zooms')[1] && (a.jU = !0), this.la[d].ne().Kc && (b = !0);
                    for (d = 0; d < this.la.length; d += 1) this.la[d].S.PP && a.jU && (!this.fj && this.la[d].S.get('visible') && ((f = this.la[d].S.PP()), (f.mFa = 1), (f.zoom = a.P.zoom)), (c = !0));
                    this.ob = [];
                    ...
                    a.Oc = this.Oc;
                    a.WJ = this.WJ;
                    if ((f = this.Qy())) f.pc(a), (this.Gi = this.jR = this.WJ = !1);
                }
            }
        },
        Qq: function (a) {
            if (!this.xI) {
                ...
                if (this.la && ((b.size = this.D.get('size')), b.size.width && b.size.height)) {
                    for (var c = this.D.view.type, d = [], e = 0, f = this.la.length; e < f; e += 1) (this.la[e].Vf && this.la[e].Vf !== c) || !(this.la[e] instanceof g.q.Pm) || 0 > a.indexOf(this.la[e].S) || (d.push(this.la[e]), this.la[e].Ij && d.push(this.la[e].Ij));
                    d.sort(function (a, b) {
                        var c = a.get('zIndex'),
                            d = b.get('zIndex');
                        return c > d ? 1 : c === d ? (a.gx > b.gx ? 1 : -1) : -1;
        ...
        Qy: function () {
            if (!this.J || this.J.type !== this.D.view.type || this.J.Ota)
        ...
        yqa: function () {
            var a = [],
                ...
                c;
            for (c in b) b[c].Sy && b[c].Sy() && a.push(b[c].Sy());
            return a;
        },
        destroyChanged: function () {
            ...
            this.eU(!0);
            this.V = {};
            this.Hc && (this.Hc.S.G('complete', this.Cr, this), this.Hc.hg(), (this.la = g.a.Ho(this.la, g.a.indexOf(this.la, this.Hc))));
        ...
        drawChanged: function () {
            ...
            if (d) {
                ...
                g.ub.load('interaction', function () {
                    var b = new g.KAa({ type: d, q: a.at }, a);
                    a.uq.push(b);
                    a.loaded = !0;
                });
            } else if (this.uq) for (b = 0, c = this.uq.length; b < c; b += 1) this.uq[b].ywa(), this.uq[b].hDa(), this.G('click', this.uq[b].UEa, this);
        },
        Zd: function (a, b, c) {
    ...
    g.Sb.Ib({
        ...
        zoomEnableChanged: function () {
            this.get('zoomEnable') ? (g.l.Uf && this.RP && '3D' !== this.D.view.type && this.RP(), g.l.ba || this.Gca()) : (g.l.Uf && this.jT && this.jT(), g.l.ba || this.o_());
        },
        ...
        Mi: function (a, b, c, d) {
            ...
            f.Of = this.Qd(f.Ta);
            c || ((c = this.FB ? (this.FB ? [this.FB] : null) : this.cfa(f.Ta, d)) && 0 < c.length && c[0].vo && ((e = c[0].vo), (f.uu = c[0])));
            e || 'info' === a.af || (e = this);
            f.jd = e;
            f.KBa = a.altKey;
            f.ctrlKey = a.ctrlKey;
            ...
            f.xT = a;
            e && 'AMap.LabelMarker' === e.CLASS_NAME && ((f.lnglat = f.Of), (f.pixel = f.Db), (f.target = e), (f.data = e.XW), (f.originEvent = a));
    ...
    g.Sb.Ib({
        ...
        i7: function (a) {
            ...
            this.ou();
            this.A8();
            !a.P5 && this.D.get('limitBounds', null, !0) ? ((a = this.nna()) && !a.hb(this.get('center')) ? this.XK(this.get('zoom'), a, !1, !0) : this.qa('moveend')) : this.qa('moveend');
            this.set('display');
        },
        j7: function () {
            this.Kf = !0;
        ...
        qa: function (a, b) {
            if (this.D.we(a)) {
                var c;
                b && (c = b.U6 ? { type: a, newsize: b.U6, oldsize: b.Eua } : { type: a, pixel: b.Db, target: this.D, lnglat: b.Of, originEvent: b.xT });
                this.D.r(a, c);
            }
        },
        IM: function () {
        ...
        eH: function (a, b) {
            ...
            c === this.get('zoom') || (this.Wf && this.Wf.aw && c === this.Wf.end) || this.sA(c, !1, a);
        },
        A_: function (a) {
            this.qa('click', a);
        },
        ...
        HM: function () {
            this.ZC && ('3D' === this.D.view.type ? (this.h('dragstart', this.K_), this.h('dragging', this.G_), this.h('dragend', this.I_)) : (this.h('dragstart', this.J_), this.h('dragging', this.F_), this.h('dragend', this.H_)));
        },
        AO: function () {
            this.ZC || ('3D' === this.D.view.type ? (this.G('dragstart', this.K_), this.G('dragging', this.G_), this.G('dragend', this.I_)) : (this.G('dragstart', this.J_), this.G('dragging', this.F_), this.G('dragend', this.H_)));
        },
        J_: function (a) {
            this.YS(a);
            this.ou();
            ...
            this.V.Hy = a.Db.x;
            this.V.$C = a.Db.y;
            this.Ie && (this.Ie.stop(), this.vs(!0));
            this.qa('dragstart');
            this.qa('movestart');
            this.r('movestart', a);
            this.bya();
        ...
        F_: function () {
            ...
            if (c || b) {
                ...
                this.ap(this.Ya.Yr, b, c);
                a.x = (a.x + g.a.Fa) % g.a.Fa;
                this.set('centerCoords', a, !0);
                this.set('center', this.Qd(a), !0);
                this.xv && (this.ih ? ((a = new Date()), (this.$t = 100 < a - this.ih ? new g.H(0, 0) : new g.H(b, c)), (this.ih = a)) : (this.ih = new Date()));
                this.qa('dragging');
                this.qa('mapmove');
            ...
            if (this.xv && this.$t)
                if (this.V.Kf) {
                    ...
                    this.Ie.Kq = function (a) {
                        if (2 > Math.abs(a.x) && 2 > Math.abs(a.y)) this.Ie.stop(), this.r('moveend'), this.vs(), (this.$t = this.ih = null);
                        else {
                            var b = a.x,
                                e = a.y,
                                f = this.rotation;
                    ...
                    this.Ie.On(this);
                } else this.r('moveend'), this.vs(!0), (this.$t = this.ih = null);
            else this.r('moveend'), this.vs(), (this.$t = this.ih = null);
        },
        bya: function () {
            if (!this.V.refresh) {
                var a = this,
                    b = null;
                this.V.refresh = setInterval(
                    function () {
        ...
        KV: function () {
            if (g.l.Zl && (g.l.sL || g.l.XH)) {
                ...
                for (b = 0; b < this.la.length; b += 1) (c = this.la[b]), 'undefined' !== typeof AMap.IndoorMap && c instanceof AMap.IndoorMap && (c.wu && (c.wu.width = 0), c.Yx && (c.Yx.width = 0));
            }
        },
        vs: function (a) {
    ...
    g.QW = g.da.extend({
        ...
        Xna: function () {
            ...
            if (this.get('center') instanceof g.U) {
                ...
                a = this.map.Cb(a.Qo());
                this.yM = { Jc: b.x, hc: b.y, Ic: a.x, tc: a.y };
            } else (a = this.map.get('limitBounds', null, !0)), (this.yM = { Jc: a[0], hc: a[1], Ic: a[2], tc: a[3] });
        },
        tD: function () {
            var a = this.map,
                b = this.get('zoom');
            return { zoom: b, ph: this.get('center'), Ha: this.lm(), mb: this.get('centerCoords'), rotation: parseInt(this.get('rotation')), Qf: a.get('crs'), T: Math.pow(2, 20 - b), oe: Math.round(b), Hg: Math.pow(2, 20 - Math.round(this.get('zoom'))) };
        },
    ...
    g.PF = g.QW.extend({
        ...
        zg: function (a, b) {
            var c = this.get('size').RE().md(2),
                ...
                c = this.get('centerCoords').add(new g.H(c, d).Pd(Math.pow(2, 20 - (b || this.get('zoom')))));
    ...
    g.sM = g.QW.extend({
        ...
        T3: function () {
            return { height: this.qn, fov: this.dqa, aspect: this.wC, near: this.uz, far: this.NI, position: this.$ma, rotation: this.De.rotation, pitch: this.De.pitch };
        },
        Voa: function () {
            this.Tga = g.a.eg();
        },
        ...
        uL: function () {
            ...
            this.$ma = { x: a.x - g.a.ec.x, y: a.y - g.a.ec.y };
            ...
            this.dc = new g.Dc()
                .e9(0, 0, -this.qn)
                .multiply(a.multiply(c.multiply(d)))
                .toFixed(8);
        ...
        L6: function (a) {
            for (var b = this.get('centerCoords'), c = g.a.ec.x, d = g.a.ec.y, e = this.get('size'), f = g.a.Fa, h = b.x + f / 2, b = b.x - f / 2, k = [], l = new g.Gl([0, 0, 0, 1]), m = l.elements, n = new g.H(0, 0), p = g.Dc.multiply(this.Me, this.dc), q = 0, r = a.length; q < r; q++)
                if (a[q]) {
                    a[q].concat ? ((n.x = a[q][0]), (n.y = a[q][1]), (n.z = -a[q][2] || 0)) : ((n.x = a[q].x), (n.y = a[q].y), (n.z = -a[q].z || 0));
    ...
    g.Sb.Ib({
        ...
        sA: function (a, b, c, d) {
            ...
            if (e !== a) {
                ...
                var m;
                this.Hd && this.Hd.aw && (this.Hd.stop(), this.Hd.gS && (d = !0), this.Hd.uD && (m = !0), (this.Hd = null), this.set('targetLevel', null));
                this.Wf && this.Wf.aw && (this.Wf.stop(), (d = !0), this.Wf.uD && (m = !0), (this.Wf = null), this.set('targetLevel', null));
                h && !d && this.qa('zoomstart');
                k && !m && this.qa('movestart');
                this.r('zoomstart');
                b
                    ? c.call(this, a)
                    : ((this.Wf = new g.Lj(e, a, null, 0.04)),
                      (this.Wf.gS = h),
                      (this.Wf.uD = k),
                      (this.Wf.transition = function (a, b, c) {
        ...
        XK: function (a, b, c, d) {
            ...
            var e = b ? this.Cb(b).toFixed(3) : this.Hd ? this.Hd.G9 : this.get('centerCoords'),
                ...
                k = (b = !1);
            this.Wf && this.Wf.aw && (this.Wf.stop(), (b = !0), this.Wf.uD && (k = !0), (this.Wf = null), this.set('targetLevel', null));
            this.Hd && this.Hd.aw && (this.Hd.stop(), this.Hd.gS && (b = !0), this.Hd.uD && (k = !0), (this.Hd = null), this.set('targetLevel', null));
            this.Ie && (this.Ie.stop(), (this.Ie = null));
            if (f || h) {
                if (!this.D.view.lm().contains(e) || (f && '3D' !== this.D.view.type && (g.l.ba || g.l.Ve))) c = !0;
                if (c) f && (b || (this.r('zoomstart'), this.qa('zoomstart')), this.set('zoom', a), this.qa('zoomchange'), this.qa('zoomend'), this.r('zoomend')), h && (k || d || (this.qa('movestart'), this.r('movestart')), this.set('centerCoords', e), this.qa('mapmove'), this.r('moveend', { P5: d })), this.set('targetLevel', null);
                else {
                    this.set('targetLevel', a);
                    ...
                    this.Hd.transition = function (a, b, c) {
                        return Math.pow(1 - Math.min(g.o.SH, c) / g.o.SH, 2);
                    };
                    this.Hd.Kq = function (b) {
                        0.02 > b ? (this.Hd && (this.Hd.stop(), (this.Hd = null)), f && (this.set('zoom', a), this.qa('zoomchange'), this.qa('zoomend'), (f = !1), this.r('zoomend')), h && (this.set('centerCoords', e), this.r('mapmove'), this.r('moveend', { P5: d })), this.set('targetLevel', null)) : (f && this.set('zoom', a - l * b), h && ((b = e.bb(m.Pd(b)).toFixed(3)), this.set('centerCoords', b), this.qa('mapmove')));
                        this.set('display', 1);
                    };
                    this.Hd.On(this);
                    f && !b && (this.r('zoomstart'), this.qa('zoomstart'));
                    !h || k || d || (this.r('movestart'), this.qa('movestart'));
                }
            }
        },
    });
    ...
    g.q.Zb = g.da.extend({
        ...
        hg: function () {
            this.Ei && this.kQ();
            if (g.Ca && g.Ca.lr && g.Ca.lr.length) {
                var a = g.a.indexOf(g.Ca.lr, this);
                -1 !== a && (g.Ca.lr = g.a.Ho(g.Ca.lr, a));
            }
            if ((a = this.Ob)) {
        ...
        opacityChanged: function () {
            ...
            if ((a = this.Ob))
                if (a.length) for (var b = 0; b < a.length; b += 1) this.GU(a[b]);
                else this.GU(a);
        ...
        cJ: function () {
            ...
            if (a) {
                ...
                } else a instanceof g.Xf ? (this.I = [a.kc.x, a.kc.y, a.Xd.x, a.Xd.y]) : a instanceof g.QF && '3D' === this.S.Vf && ((b = a.path[1]), (d = this.e.Cb(a.path[0])), (e = this.e.Cb(b)), (this.I = [d.x, d.y, e.x, e.y, a.Q8, a.height]));
                return this.I;
            }
            return null;
        },
    ...
    g.pg = g.da.extend({
        ...
        set: function (a, b) {
            var c = this.yY(a);
            c ? (c.value = b) : ((c = new g.pg.ur(a, b)), (this.e[a] = c), this.vB(c), (this.count += 1), this.count > this.Kp && this.w1(this.Kp));
        },
        Aw: function (a) {
            this.remove(a);
        },
        ...
        push: function (a) {
            a = new g.pg.ur('', a);
            0 === this.count ? ((this.dd.Ia = null), (a.Ia = this.dd), (this.dd.next = a)) : ((this.kC.next = a), (a.Ia = this.kC));
            this.count += 1;
            this.kC = a;
        },
        sza: function (a) {
        ...
        w1: function (a) {
            if (!(this.count <= a || this.count < 2 * this.EB.length)) {
                ...
                for (a = Math.ceil((2 * a) / 3); b && this.count > a && ((d = this.WF ? b.Ia : b.next), b.key && !c[b.key] && this.WB(b) && this.kK(b.value), (b = d), b !== this.dd && b !== this.kC); );
            }
        },
        WB: function (a) {
        ...
        clear: function () {
            this.e = {};
            this.dd = new g.pg.ur('', null);
            this.dd.Ia = this.dd.next = this.dd;
            this.count = 0;
        },
    });
    g.pg.ur = function (a, b) {
        this.key = a;
        this.value = b;
    };
    g.pg.ur.prototype.Ia = null;
    g.pg.ur.prototype.next = null;
    g.pg.ur.prototype.remove = function () {
    ...
    g.yF = g.da.extend({
        ...
        PM: function (a) {
            a && this.Mn.count >= this.O2 && ((a = this.Mn.dd.Ia.value), a.rn && (this.Mn.remove(a.url), this.hX(a)));
        ...
        gea: function (a) {
            ...
            a.fqa && (b.crossOrigin = 'anonymous');
            b.src = a.url;
            a.Ba = b;
            a.Jta = this;
            a.startTime = +new Date();
            a.OK = !0;
            b.complete ? Rc(a, !0) : (this.Mn.set(a.url, a), (b.onload = Qc(a, !0)), (b.onerror = Qc(a, !1, !0)), (b.onabort = Qc(a, !1)), (a.Aya = setTimeout(Qc(a, !1, !0), this.timeout)));
        },
        hX: function (a) {
        ...
        clear: function (a) {
            ...
            this.Pq.clear();
            if (a) for (; 0 < this.Mn.length; ) (a = this.Mn.pop()), this.hX(a);
            else
                this.Mn.forEach(function (a) {
                    a.rn = !0;
                });
        },
    });
    ...
    g.q.sb = g.q.Zb.extend({
        ...
        styleChanged: function () {
            this.e.Cd || (this.set('reload'), this.S.ct());
        },
        featuresChanged: function () {
            this.set('reload');
            this.S.ct();
        ...
        tileFunChanged: function () {
            ...
            this.Do = function (b, c, d) {
                ...
                if (!b.Ks || b.Ks.rn)
                    (b.loaded = !1),
                        (b.Ks = ('3D' === this.e.D.view.type ? g.rm.yta : g.rm.oz).call(
                            g.rm,
                            e,
                            function (a) {
                                b.Ks = null;
        ...
        ne: function () {
            ...
            return { Fd: this.S.get('tileSize'), visible: this.S.get('visible'), I: this.cJ(), Za: a, aI: this.Jl, Zi: this.Zi, $i: this.$i, opacity: this.S.get('opacity'), Do: this.S.get('createTile'), Ro: this.iL || this.S.get('tileFun'), Kc: this.S.Hq ? !1 : this.S.get('detectRetina') && g.l.ja && g.l.ba, Oc: this.zn() };
        },
        bm: function (a) {
    ...
    g.q.gd = g.q.Zb.extend({
        A: function (a, b) {
            ...
            this.Lv = [];
            this.gm = new g.q.naa();
            a && (this.X('style', a), this.X('cursor', a, !0), (this.Zxa = a.get('stable') || !1), this.X('dataSources', a), this.X('bubble', a));
            this.X('display', b);
            this.Bca();
        },
        ne: function () {
            return { visible: this.get('visible'), Za: this.get('zooms'), opacity: this.get('opacity'), zIndex: this.get('zIndex'), gy: this.S.get('alwaysRender') || !1, Oc: this.zn() };
        },
        dataSourcesChanged: function () {
            ...
            a && a.length
                ? 'string' === typeof a
                    ...
                    : a.length && (this.A7(a), (this.ms = a), (this.om = !0), this.set('display'), (this.Ra = !0), this.S.r('complete'))
                : this.clear();
        },
        getDatas: function () {
            return this.ms;
        ...
        qa: function (a, b) {
            var c = { type: a, data: 'mouseout' === a ? this.Rga || null : b.uu.ib, target: this.S, originEvent: b.xT };
        ...
        dra: function (a) {
            if ('geojson' === a) return new g.taa({ map: this.map });
            if ('topjson' === a) return new g.hBa({ map: this.map });
            if ('subway' === a) return new g.cBa({ map: this.map });
        },
        Kva: function (a) {
            if (a) {
                var b = [],
                ...
                if (a.rules) {
                    for (var b = a.rules, d = 0, e = b.length; d < e; d += 1) {
                        for (var f = [], h = b[d].symbolizers, k = 0, l = h.length; k < l; k += 1) h[k].fill && (f[k] = new g.style.Og.eW(h[k].fill)), h[k].stroke && (f[k] = new g.style.Og.JW(h[k].stroke));
                        h = f;
                        b[d].fL = h;
                ...
                if (a.symbolizers) {
                    b = a.symbolizers;
                    a = 0;
                    for (d = b.length; a < d; a += 1) b[a].fill && (b[a] = new g.style.Og.eW(b[a].fill)), b[a].stroke && (b[a] = new g.style.Og.JW(b[a].stroke));
                    c.fL = b;
                }
                a = new g.nM(c);
            } else a = new g.nM({});
        ...
        cy: function (a) {
            this.om = !0;
            for (var b = 0, c = a.length; b < c; b += 1) this.QH(a[b]);
        },
        clear: function () {
            this.om = !0;
            this.ms = [];
        ...
        featureChanged: function (a) {
            ...
            var b = a.target,
                c = b.fc();
            0 !== this.gm.Lqa([g.a.zb(b)]).length && (this.gm.remove(b, a.Nv), c && !a.Koa && this.gm.add(b));
        },
        m8: function (a) {
            this.om = !0;
            for (var b, c = 0, d = a.length; c < d; c += 1) (b = a[c]), (b.W.Nv = null), b.us(!0), b.yl('feature');
        },
        FHa: function (a, b) {
    ...
    g.q.gd.Ib({
        cm: function (a) {
            return this.YC ? new g.Ea.Le.Hl(this, a) : this.S.Aj ? new g.Ea.Uaa(this, a) : new g.Ea.Hl(this, a);
        },
    });
    g.q.naa = g.da.extend({
        A: function () {
        ...
        add: function (a) {
            var b = g.a.zb(a),
                c = a.fc();
            this.sq[b] || ((this.count += 1), (this.sq[b] = a), c && !g.I.hb(c.Md(), [Infinity, Infinity, -Infinity, -Infinity]) && this.PT.Is(c.Md(), a));
        },
        vEa: function () {
            return this.sq;
        },
        ...
        remove: function (a, b) {
            var c = g.a.zb(a).toString(),
                d = a.fc();
            this.sq[c] && ((this.sq[c] = null), d && ((c = 'undefined' !== typeof b ? b : d.Md()), this.PT.remove(c, a)));
        },
    });
    g.Lk = g.da.extend({
        A: function (a) {
            ...
            this.SK = { I: [Infinity, Infinity, -Infinity, -Infinity], Kb: [] };
            this.count = 0;
        },
        tna: function (a, b) {
            var c = -1,
            ...
            do {
                ...
                for (var h = f.length - 1; 0 <= h; h -= 1) {
                    ...
                    var l = g.Lk.Vz(k.I[2] - k.I[0], k.I[3] - k.I[1], k.Kb.length + 1),
                        k = g.Lk.Vz((k.I[2] > a.I[2] ? k.I[2] : a.I[2]) - (k.I[0] < a.I[0] ? k.I[0] : a.I[0]), (k.I[3] > a.I[3] ? k.I[3] : a.I[3]) - (k.I[1] < a.I[1] ? k.I[1] : a.I[1]), k.Kb.length + 2);
                ...
                do {
                    ...
                    if ('undefined' !== typeof e.We || 'undefined' !== typeof e.Kb || f) {
                        ...
                        if (c.Kb.length <= this.B6)
                            if (0 < d.length) e = { I: g.I.eb(c.I) };
                            else break;
                        else (e = f = this.nta(c.Kb)), 1 > d.length && (c.Kb.push(f[0]), d.push(c), (e = f[1]));
        ...
        Qva: function (a, b, c) {
            for (var d = g.Lk.Vz(b.I[2] - b.I[0], b.I[3] - b.I[1], b.Kb.length + 1), e = g.Lk.Vz(c.I[2] - c.I[0], c.I[3] - c.I[1], c.Kb.length + 1), f, h, k, l = a.length - 1; 0 <= l; l -= 1) {
                var m = a[l],
                    ...
                    p = Math.abs(m - n);
                if (!h || !f || p < f) (h = l), (f = p), (k = m < n ? c : b);
            }
            d = a.splice(h, 1)[0];
            b.Kb.length + a.length + 1 <= this.XJ ? (b.Kb.push(d), g.I.extend(b.I, d.I)) : c.Kb.length + a.length + 1 <= this.XJ ? (c.Kb.push(d), g.I.extend(c.I, d.I)) : (k.Kb.push(d), g.I.extend(k.I, d.I));
        },
        remove: function (a, b) {
            var c = [];
            c[0] = { I: a };
            ...
            if (!1 === c[1]) {
                var d = 0,
                    e = [];
                do (d = e.length), (e = e.concat(this.p8.apply(this, c)));
                while (d !== e.length);
                return e;
            }
            ...
            do {
                ...
                if ('undefined' !== typeof b)
                    for (; 0 <= k; ) {
                        var l = c.Kb[k];
                        if (g.I.$g(a, l.I))
                            if ((b && 'undefined' !== typeof l.We && l.We === b) || (!b && ('undefined' !== typeof l.We || g.I.P2(a, l.I)))) {
                    ...
                    h.length = 0;
                    0 === d.length && 1 >= c.Kb.length ? ((h = this.Pz(c, !0, h, c)), (c.Kb.length = 0), d.push(c), e.push(1)) : 0 < d.length && c.Kb.length < this.XJ ? ((h = this.Pz(c, !0, h, c)), (c.Kb.length = 0)) : (h = void 0);
                } else g.Lk.ZT(c);
            } while (0 < d.length);
            return f;
        },
        search: function (a, b) {
            return this.Pz({ I: a }, !1, [], this.SK, b);
        },
        ixa: function (a, b) {
            return this.Pz({ I: a }, !1, [], this.SK, b, !0);
        },
                ...
                for (var l = d.length - 1; 0 <= l; l -= 1) {
                    ...
                    if (g.I.$g(a.I, m.I))
                        if ('undefined' !== typeof m.Kb) k.push(m.Kb);
                            ...
                            if (b) c.push(m);
                            else if ('undefined' === typeof e || m.type === e) (m = m.We), 'undefined' !== typeof f ? (h[g.a.zb(m)] = m) : c.push(m);
                }
            } while (0 < k.length);
    ...
    g.B.Fh = g.da.extend({
        ...
        qa: function (a, b) {
            var c;
            c = b ? { type: a, pixel: b.Db, target: this.Mb, lnglat: b.Of, originEvent: b.xT } : { type: a };
            this.Mb && this.Mb.r(a, c);
        },
        sc: function (a) {
            (('click' !== a.type && 'rightclick' !== a.type && 'dblclick' !== a.type && 'longclick' !== a.type) || this.get('clickable')) && this.qa(a.type, a);
        },
        GM: function () {
            this.h('click', this.sc);
        ...
        eu: function (a) {
            ...
            if ('2D' == b) {
                ...
                this.ap(new g.H(e, b));
                this.qa('dragging', a);
            } else '3D' == b && a.Ta && ((c = a.Db.bb(this.gg)), (b = c.x), (c = c.y), (e = a.Ta.bb(this.b6)), a.Of.bb(this.a6), (this.gg = a.Db), 'function' === typeof this.tz && this.tz(b, c, e), (this.b6 = a.Ta), (this.a6 = a.Of), this.qa('dragging', a));
        },
        fu: function (a) {
            this.map.yw();
    ...
    g.B.wb = g.B.Fh.extend({
        ...
        fma: { AMAP_ANIMATION_NONE: !1, AMAP_ANIMATION_DROP: g.Lj.Easing.Bounce, AMAP_ANIMATION_BOUNCE: g.Lj.Easing.Cubic },
        A: function (a, b) {
            arguments.callee.ma.apply(this, arguments);
            this.bf(this.hE, a);
            this.X('move', a);
        ...
        A0: function () {
            ...
            if (this.or) this.or.set('position', this.get('position'));
            else {
                var a = new z.B.wb({ zIndex: this.get('zIndex') - 1, icon: new z.B.di({ image: g.o.Hb + '/theme/v1.3/dragCross.png', size: new g.yd(14, 11), innerOverlay: !0 }), offset: new g.H(-4, -5), position: this.get('position'), innerOverlay: !0 });
                a.Da = !0;
                this.or = a;
            }
            this.or.C = !0;
            this.or.setMap(this.map.D);
            this.or.C = !1;
        },
        mY: function () {
        ...
        animationChanged: function () {
            ...
            a && 'AMAP_ANIMATION_NONE' !== a && ('AMAP_ANIMATION_DROP' === a ? this.SN(!0, 'in', 100) : this.SN());
        },
        sg: function () {
            this.or && this.or.set('position', this.get('position'));
        },
        raiseOnDragChanged: function () {
            this.get('raiseOnDrag') ? (this.h('dragstart', this.A0, this), this.h('dragging', this.sg, this), this.h('dragend', this.mY, this)) : (this.G('dragstart', this.A0, this), this.G('dragging', this.sg, this), this.G('dragend', this.mY, this));
        },
        ap: function (a) {
        ...
        Vma: function () {
            ...
            e = a
                ? this.f2(a, c)
                : this.VP(this.get('icon'), function () {
                      f.L && f.L.fa ? (g.l.Ai && g.a.iepngFix(e), f.offsetChanged(), f.tL()) : f.map && f.map.set('display');
                  });
        ...
        Hu: function () {
            ...
            if (this.map && a && !this.L) {
                var b = this.map,
                    a = this.map.Cb(a),
                    a = (this.L = new g.bi({ name: 'marker-' + g.a.zb(this), map: b, W: new g.Aa.Ng([a.x, a.y]) }));
        ...
        getParams: function () {
            return { zIndex: this.get('zIndex'), Tp: this.get('angle'), Vg: this.get('contentDom'), KJ: this.get('labelDom'), g9: this.get('shadowDom'), opacity: this.get('opacity'), altitude: this.get('altitude'), title: this.get('title'), label: this.get('label'), pF: this.get('AnimationOffset'), verticalAlign: this.get('verticalAlign'), textAlign: this.get('textAlign'), offset: this.get('offset'), U5: this.get('isTop'), shape: this.get('shape'), visible: this.get('visible') && !this.Mb.get('outOfZooms'), anchor: this.get('anchor') };
        },
        ...
        UF: function () {
            this.L && ((this.L.Xj = null), (this.L.se = !0), this.map && ((this.map.ud.nm = !0), this.map.set('display')));
        },
        contentChanged: function () {
            if (this.L) {
                this.L.Xj = null;
                this.map.ud.nm = !0;
                -1 === g.a.indexOf(this.map.ud.bh, this.L) && this.map.ud.bh.push(this.L);
                ...
                this.L.fa ? (g.l.Ai && g.a.iepngFix(a), this.L.fa.appendChild(a), (this.L.Vg = a), this.offsetChanged(), this.tL()) : this.map && this.map.set('display');
                this.titleChanged();
            }
        },
            ...
            if (this.L && !this.get('content')) {
                ...
                var b = this,
                    c = this.VP(a, function () {
                        b.L && b.L.fa ? (g.l.Ai && g.a.iepngFix(c), b.offsetChanged(), b.tL()) : b.map && b.map.set('display');
                    });
                this.set('contentDom', c);
                this.L.fa && (this.L.fa.appendChild(c), (this.L.Vg = c));
                this.titleChanged();
            }
        },
        ...
        labelChanged: function (a) {
            ...
            if (this.L && this.L.fa) {
                ...
                a && a.content && ((c = ''), a.content && ((c = this.WP(a.content)), b.appendChild(c), this.tL(a, c)), this.set('labelDom', c));
            } else a && a.content ? this.set('labelDom', this.WP(a.content), !0) : this.set('labelDom', null);
        },
        isTopChanged: function () {
            var a = this.map.ud.kL,
                b = this.get('isTop'),
                c = this.get('zIndex');
            a ? (a === this ? this.L && this.L.fa && ((this.L.fa.style.zIndex = b ? this.map.ud.fr + 10 : c), (this.map.ud.kL = b ? this : null)) : (a.L && a.L.fa && (a.L.fa.style.zIndex = b ? a.get('zIndex') : this.map.ud.fr + 10), this.L && this.L.fa && (this.L.fa.style.zIndex = b ? this.map.ud.fr + 10 : c), (this.map.ud.kL = b ? this : a))) : ((this.map.ud.kL = this), this.L && this.L.fa && (this.L.fa.style.zIndex = b ? this.map.ud.fr + 10 : c));
        },
        visibleChanged: function () {
        ...
        zIndexChanged: function () {
            ...
            if (a > this.map.ud.fr) {
                this.map.ud.fr = a;
                var b = this.map.ud.kL;
                b && b.L && b.L.fa && (b.L.fa.style.zIndex = a + 10);
            }
            this.L && this.L.fa && (this.L.fa.style.zIndex = this.get('isTop') ? this.map.ud.fr + 10 : this.get('zIndex'));
        },
        opacityChanged: function () {
            var a = this.get('contentDom'),
        ...
        VP: function (a, b) {
            var c,
                ...
                m,
                n;
            a ? ('string' === typeof a ? ((c = a), (n = !0)) : ((c = a.get('image')), (e = a.get('size')), (f = a.get('imageSize')), (d = e.width), (e = e.height), f && ((l = f.width), (m = f.height))), (f = 'string' !== typeof a ? a.get('imageOffset') : { x: 0, y: 0 })) : ((c = g.o.Ii + '/mark_bs.png'), (f = { x: 0, y: 0 }), (d = 19), (e = 33), (l = 19), (m = 33));
            ...
            k.style.left = f.x + 'px';
            h.appendChild(k);
            g.f.Yq(g.l.Ve && n ? k : h, this.get('opacity'));
            (d && e) || (h.AM = !1);
            g.F.h(
                k,
                'load',
                function q() {
                    ...
                    this.map && this.map.ud && (this.map.ud.nm = !0);
                    g.F.G(k, 'load', q, this);
                    if (this.L && this.L.fa) {
        ...
        moveChanged: function () {
            ...
            void 0 !== a && ('pause' === a.action ? this.Nva() : '[object Array]' === Object.prototype.toString.call(a.Of) ? a.Of && ('resume' === a.action && this.PG ? this.moveTo(a.Of[a.Of.Mp || 0], a.speed, a.yb) : (this.PG && this.r('movestop'), (a.Of.Mp = 0), this.set('position', a.Of[0]), this.pua(a.Of, a.speed, a.yb, a.xna))) : this.moveTo(a.Of, a.speed, a.yb, !0));
        },
        moveTo: function (a, b, c, d) {
            if (!(0 >= b)) {
                ...
                this.zh.Kq = function (b) {
                    this.set('position', b);
                    d && this.Mb.r('moving', { target: this.Mb, passedPath: [this.zh.start, this.get('position')] });
                    this.r('moving');
                    b.hb(a) && (this.zh && (this.zh.stop(), (this.zh = null)), this.Mb.r('moveend', { target: this.Mb }), this.r('moveend'));
                };
                this.get('autoRotation') && !g.l.Ve && ((b = '2D' == (this.map.D.view.type || '2D') ? this.$ea(e, a) : this.afa(e, a)), this.set('angle', b));
                this.zh.On(this);
            }
        },
        fya: function () {
            this.zh && (this.zh.stop(), (this.zh = null), this.r('movestop'));
        },
        Nva: function () {
    ...
    g.B.Un = g.B.Fh.extend({
        ...
        hg: function () {
            this.K && (this.map.G('click', this.SBa, this), this.map.Ya.B.removeChild(this.K), (this.Up.ri = !1), (this.K = this.Up.De.map = null), this.map.G('movestart', this.bn, this), this.map.G('zoomstart', this.bn, this), this.map.G('click', this.bn, this), this.map.G('closeOverlays', this.bn, this), this.map.G('rotate', this.bn, this));
        },
        visibleChanged: function () {
    ...
    g.B.Ze = g.B.Fh.extend({
        ...
        BV: function () {
            ...
            if (!a && b) {
                var a = this.LU,
                    ...
                    c = b.height - 23,
                    d = b.width;
                if (g.l.Ai || g.l.vv) (c = this.qh.childNodes[0].offsetHeight), (d = this.qh.childNodes[0].offsetWidth + 26);
                b = 'background-image:url(' + g.o.Hb + (g.l.Ai ? '/theme/v1.3/iws.gif);' : '/theme/v1.3/iws.png);');
                a.innerHTML = '';
                var e = [],
                    f;
                f = e[1] = {};
                ...
                f.top = -15;
                f.left = d / 2 - 15;
                for (c = 1; 8 >= c; c += 1) (d = g.f.create('div', a)), (f = []), f.push('position:absolute;'), f.push(b), f.push('top:' + e[c].top + 'px;'), f.push('left:' + e[c].left + 'px;'), f.push('width:' + e[c].width + 'px;'), f.push('height:' + e[c].height + 'px;'), f.push('background-position:' + -e[c].offsetX + 'px ' + -e[c].offsetY + 'px;'), (d.style.cssText = f.join(''));
            }
        },
        jIa: function () {},
        Gm: function () {
            ...
            if (a && b && c) {
                ...
                if (g.l.Ai || g.l.vv) e.width = this.qh.childNodes[0].offsetWidth + 14;
                b = e.height;
                c = this.get('offset');
                this.get('isCustom');
                e = e.width;
                ...
                if (d) {
                    ...
                    switch (d) {
                        case 'left':
                            ...
                            break;
                        case 'right':
                            this.Rc.style.left = Math.round(a.x - e + (c.x || 0)) + 'px';
                    }
                }
                d = this.boa;
                if (this.jQ && d.childNodes[0]) {
                    for (b = a = 0; b < d.childNodes.length; b += 1) a += d.childNodes[0].clientHeight || 0;
                    a > (this.get('size').height || d.clientHeight) ? (this.jQ.style.right = '20px') : (this.jQ.style.right = '5px');
                }
            }
        },
        Dda: function () {
            ...
            if (c) {
                var a = this.qh.offsetWidth,
                    ...
                    h = 2 - a / 2,
                    k = 2 - d;
                c && ((c = c.split('-')), 2 === c.length ? ((e = c[1]), (f = c[0])) : 1 === c.length && 'center' === c[0] && ((e = 'center'), (f = 'middle')));
                switch (e) {
                    case 'left':
                        h = 2;
                        break;
        ...
        pX: function () {
            if (this.get('position') && this.get('autoMove') && this.qh) {
                for (var a = this.map, b = new g.yd(this.qh.offsetWidth, this.qh.offsetHeight), c = a.Ns(this.get('position'), this.get('altitude')).add(this.Dda()), d = c.add(b.RE()), e = a.get('size'), f = a.yqa(), h = 0, k = 0, l = 0; l < f.length; l += 1) {
                    var m = f[l],
                        n = 0,
                        p = 0;
        ...
        Pna: function () {
            this.get('closeWhenClickMap') && (this.map.h('clickstart', this.C_, this, !1), this.map.h('clickend', this.B_, this, !1));
        },
        C_: function () {
            this.sf.ri && ((this.sf.C = !0), this.sf.getIsOpen() && (this.sf.jL = !0), (this.sf.C = !1));
        },
        B_: function () {
            this.sf.ri && (this.sf.jL && ((this.sf.C = !0), this.sf.close(), (this.sf.C = !1)), (this.sf.jL = !1));
        },
        hg: function () {
            this.Rc && this.map && ((this.sf.jL = !1), this.get('closeWhenClickMap') && (this.map.G('clickstart', this.C_, this), this.map.G('clickend', this.B_, this)), this.get('retainWhenClose') ? this.map.Nl.appendChild(this.Rc) : (this.Rc.parentNode === this.map.Ya.B && this.map.Ya.B.removeChild(this.Rc), (this.sf.B = null)), (this.map = null), (this.sf.ri = !1), this.Mb.r('close', { type: 'close', target: this.Mb }));
        },
        bCa: function () {
            if (!this.get('isCustom')) return this.qh.offsetWidth;
            for (var a = this.hi, b = a.firstChild, c = a.lastChild; b && c && b.style && c.style && b === c; ) (a = b), (b = a.firstChild), (c = a.lastChild);
            a = g.f.$c(a, 'width');
    ...
    g.Aa.Qe = g.extend({}, { Ww: 'point', QL: 'linestring', qW: 'linearring', GF: 'polygon', bM: 'multipoint', aM: 'multilinestring', CF: 'multipolygon', GAa: 'geometrycollection' });
    g.bi = g.da.extend({
        ka: [g.va, g.$e],
        A: function (a) {
            a = a || {};
        ...
        DU: function (a) {
            a && ((this.W = a), this.X('coords', a, !0), this.yB || this.UN) && (a.X('radius', this), a.X('center', this), a.X('resolution', this), a.X('strokeWeight', this));
        },
        setStyle: function (a) {
            this.Jxa(a);
            this.us();
        ...
        us: function (a) {
            this.set('feature', { target: this, Koa: a, Nv: this.W.Nv || this.W.Md(), vua: this.W.Md() });
            this.W.Nv = this.W.Md();
        },
        visibleChanged: function () {
            this.us();
        ...
        NEa: function (a) {
            for (var b = 0; b < this.vl.length; b += 1) {
                var c = this.vl[b];
                if (a.hb(c.vy(this))) return c;
            }
        },
        Gqa: function () {
            var a = this.fc(),
                b = [];
            a.zi() === g.Aa.Qe.GF || a.zi() === g.Aa.Qe.CF ? b.push(new g.style.Ce.Ec({ fillColor: '#78cdd1', me: 0.2, strokeColor: '#122e29', qb: 0.5, qc: 1 })) : a.zi() === g.Aa.Qe.QL || a.zi() === g.Aa.Qe.qW || a.zi() === g.Aa.Qe.aM ? b.push(new g.style.Ce.yp({ color: '#888888', width: 1, zIndex: 10 })) : (a.zi() !== g.Aa.Qe.Ww && a.zi() !== g.Aa.Qe.bM) || b.push(new g.style.Ce.di({ url: g.o.Hb + '/theme/v1.3/markers/0.png', width: 36, height: 36, rotation: 0, AIa: -12, CIa: -36, zIndex: 100 }));
            return b;
        },
    });
    g.bi.BAa = 'geometry';
    ...
    g.M.Zb = g.da.extend({
        ...
        nq: function (a, b, c, d) {
            ...
            if (Math.floor(e) !== e) b(c, f);
                ...
                if ((e = f.yn([a[0] - e, a[1] - h, a[0] + e, a[1] + h]))) {
                    for (var q in e)
                        if (e.hasOwnProperty(q) && ((h = e[q]), h.get('visible') && !h.get('noSelect')))
                            if (((k = h.fc()), k instanceof g.Aa.Ng))
                                if (this.Aj) {
                                    ...
                                    g.I.Ud(m, k) && c.push(h);
                                } else if ('undefined' !== typeof k.get('radius')) (l = k.za), (l = new g.H(l[0], l[1])), (m = new g.H(a[0], a[1])), (k = k.get('radius')), 'px' === h.get('unit') ? m.He(l) / Math.pow(2, 20 - this.zoom) < k && c.push(h) : m.He(l) * Math.cos((h.get('center').Q * Math.PI) / 180) <= (k / this.Dq) * Math.pow(2, 20 - this.zoom) && c.push(h);
                                else if ('AMap.Text' == h.Vp) (l = h.get('params')), l.visible && h.fa && g.f.JD(d, h.fa, 'amap-markers') && c.push(h);
                                else {
                                        ...
                                        if (l.shape)
                                            for (
                                                k = k.za,
                                                    s = l.Tp % 360,
                                                    u = [a[0], a[1]],
                                                    s && ((v = (a[0] - k[0]) / this.T), (w = (a[1] - k[1]) / this.T), (t = (Math.PI * s) / 180), (s = Math.cos(-t)), (x = Math.sin(-t)), (t = v * s - w * x), (v = v * x + w * s), (u[0] = k[0] + t * this.T), (u[1] = k[1] + v * this.T)),
                                                    m = h.width * this.T,
                                                    n = h.height * this.T,
                                                    p = l.offset.x * this.T,
                                                    r = l.offset.y * this.T,
                            ...
                            else k.Ud ? k.Ud(a) && c.push(h) : k.Fy && 1.8 * k.Fy(a) <= h.get('strokeWeight') * this.T && c.push(h);
                    this.Aj
                        ? c.sort(function (a, b) {
        ...
        ID: function (a, b, c) {
            ...
            if ('circle' === a.w.type) {
                ...
                if ('poly' === a.w.type) return (e = a.w.coords), (e = this.iI(e)), g.xd.Ud(d, e);
                if ('rect' === a.w.type)
                    return (
                        (e = a.w.coords),
                        (a = e[0]),
    ...
    g.M.Sb = g.da.extend({
        ...
        nq: function (a, b, c, d, e) {
            ...
            for (var h = b.length, k = [], l = 0, m, n = [], p = 0; p < h; p += 1) (m = b[p]), (m instanceof g.q.gd || 'AMap.LabelLayer' === m.CLASS_NAME) && m.get('visible') && (n.push(this.Bs(m)), (l += 1));
    ...
    g.V2 = {
        ...
        cra: function (a) {
            ...
            return function (a) {
                ...
                if (void 0 === e[a]) {
                    var k = b.mD(a, d, e);
                    e[a] = f && 'none' !== f && k.cK !== k.Iz && k.Nq !== k.YD ? c.H4(k.Nq, k.YD, (a - k.Iz) / (k.cK - k.Iz), f) : k.Nq;
                }
                return e[a];
            };
        },
        ...
        wqa: function (a, b, c) {
            ...
            return function (a) {
                ...
                if (void 0 === h[a]) {
                    var b = d.mD(a, f, h),
                        n = b.Nq;
                    if (k && 'none' !== k && b.Iz !== b.cK && b.Nq.join('') !== b.YD.join('')) for (var n = n.slice(0), p = (a - b.Iz) / (b.cK - b.Iz), q = 0, r = b.YD.length; q < r; q++) n[q] = e.H4(b.Nq[q], b.YD[q], p, k);
                    h[a] = n;
                }
                b = h[a];
            ...
            for (f in c)
                if (c.hasOwnProperty(f)) {
                    ...
                    void 0 !== b[h]
                        ? (b[h].nodes &&
                              1 < b[h].nodes.length &&
                              b[h].nodes.sort(function (a, b) {
                                  return a.zoom - b.zoom;
                              }),
                          (a[f] = e.Esa ? { Ye: d.call(this, b[h], c[f]), canvas: d.call(this, b[h], c[f], !0) } : d.call(this, b[h], c[f])))
                        : e.Dsa && (a[f] = !0);
                }
        },
        Sr: function (a, b) {
        ...
        D7: function (a, b, c, d) {
            var e = {},
                f = { visible: 'visible', NU: 'showLabel', wk: 'showIcon' },
                h = [
                    ['color', { color: 'color' }, { opacity: 'opacity' }],
                    ['fillColor', { fillColor: 'fillColor' }, { me: 'fillOpacity' }],
                    ['strokeColor', { strokeColor: 'strokeColor' }, { qb: 'strokeOpacity' }],
                    ['textFillColor', { pya: 'textFillColor' }, { qya: 'textFillOpacity' }],
                    ['textStrokeColor', { sya: 'textStrokeColor' }, { tya: 'textStrokeOpacity' }],
                    ['backgroundColor', { backgroundColor: 'backgroundColor' }, { rma: 'backgroundOpacity' }],
                ],
                k = { fontSize: 'fontSize' },
                l = { fillWidth: 'fillWidth', strokeWidth: 'strokeWidth' };
            if (a.styles) {
                a = a.styles;
                this.Dz(e, a, f, this.oqa, { Dsa: !0 });
                this.Dz(e, a, k, this.p4, { Ssa: !0 });
                this.Dz(e, a, l, this.p4, { Ssa: !0 });
                k = 0;
                for (l = h.length; k < l; k++) {
                    var m = h[k];
                    a[m[0]] ? this.Dz(e, a, m[1], this.wqa, { Esa: !0 }) : this.Dz(e, a, m[2], this.cra);
                }
                a.texture &&
                    (this.Dz(e, a, { Ja: 'texture' }, this.vra),
                    (e.fd = []),
                    g.a.Ub(a.texture.nodes, function (a) {
                        a.value && e.fd.push(g.o.Cc + '://' + a.value);
                    }));
            } else {
                for (var n in f)
                ...
                for (n = h.length; f < n; f++) {
                    var q = h[f],
                        ...
                        s = g.a.keys(q[2])[0],
                        q = q[2][s];
                    void 0 !== a[r] ? (e[p] = { canvas: this.Sr(a[r], 'str'), Ye: this.Sr(a[r]) }) : (e[s] = a[q]);
                }
            ...
            if (a)
                for (var e in a)
                    if (a.hasOwnProperty(e) && g.a.kk(a[e], 'object')) {
                        ...
                        else if (void 0 !== f.code) for (var k in d) d.hasOwnProperty(k) && !g.a.ka(['isDetailed', 'detailedType', 'styles'], k) && void 0 === f[k] && void 0 !== d[k] && (f[k] = d[k]);
                    }
        },
        yV: function (a) {
                    ...
                    if (this.be.hasOwnProperty(d)) {
                        ...
                        for (var f in e)
                            if (e.hasOwnProperty(f)) {
                                ...
                                if (h) {
                                    c[d][f] = {};
                                    for (var k in h) h.hasOwnProperty(k) && void 0 !== h[k] && ((c[d][f][k] = {}), h[k].Ye ? (b(h[k].Ye) ? (c[d][f][k].Ye = h[k].Ye(a)) : (c[d][f][k].Ye = h[k].Ye), b(h[k].canvas) ? (c[d][f][k].canvas = h[k].canvas(a)) : (c[d][f][k].canvas = h[k].canvas)) : b(h[k]) ? (c[d][f][k] = h[k](a)) : (c[d][f][k] = h[k]));
                                } else c[d][f] = h;
                            }
                    }
                this.em = c;
        ...
        styleChanged: function () {
            if (this.e.D.Ci) {
                ...
                this.fl.SA || ((this.fl = g.a.bind(this.fl, this)), (this.lq = g.a.bind(this.lq, this)), (this.fl.SA = !0));
                var b = g.a;
                if (a) {
                    var c = {};
                    this.CT(a, c);
                ...
                if (d) {
                    ...
                    if (d.visible) {
                        ...
                        s && ((c = this.Dt(s, d.visible, 'rgba(0, 0, 0, 0)')), (s = this.fl(b.qp(this.e.Ee.substr(1)), d.opacity, d.color, !0, a)), (l = this.Dt(s, d.visible)));
                    }
                    this.e.Pu = c;
                } else this.e.Pu = '';
                e && e.visible && ((m = this.fl(b.qp(this.e.MH.substr(1)), e.opacity, e.color, !0, a)), (m = this.Dt(m, e.visible)));
                f && f.visible && ((n = this.fl(b.qp(this.e.qu.substr(1)), void 0, f.color, !0, a)), (n = this.Dt(n, f.visible)), (p = this.Dt(n, f.visible)));
                h && h.visible && ((d = h.color), !d && f && f.color && (d = f.color), (p = this.fl(b.qp(this.e.qu.substr(1)), void 0, d, !0, a)), (p = this.Dt(p, h.visible)));
                k && (k.visible ? ((q = this.fl(b.Yk(this.e.XF[0]), void 0, k.fillColor, !0, a)), (q = this.Dt(q, k.visible)), (r = this.fl(b.Yk(this.e.XF[1]), void 0, k.strokeColor, !0, a)), (r = this.Dt(r, k.visible))) : ((q = [1, 1, 1, 0]), (r = [1, 1, 1, 0])));
        ...
        zs: function (a, b, c, d) {
            ...
            var e = null,
                f = a;
            d = d || this.Hj;
            (e = this.sD(b, d)) && (f = ('function' === typeof e.visible && !e.visible(d)) || !1 === e.visible ? '' : c(a, e.opacity, e.color, !1, d));
            this.Es === b && (f = this.iv(f || a));
            return f;
        },
        Oy: function (a, b, c, d, e, f) {
            ...
            f = f || this.Hj;
            var r = this.sD(d, f);
            r && (('function' === typeof r.visible && !r.visible(f)) || !1 === r.visible || ('function' === typeof r.NU && !r.NU(f)) || !1 === r.NU ? ((n = m = !1), (h = k = l = '')) : ((h = this.lq(a, r.qya, r.pya, !1, f)), (k = this.lq(b, r.tya, r.sya, !1, f)), (l = this.lq(c, r.rma, r.backgroundColor, !1, f)), (m = 'function' === typeof r.wk ? r.wk(f) : r.wk), r.fontSize && ((p = 'function' === typeof r.fontSize ? r.fontSize(f) : r.fontSize), (p = 12 <= p ? p : 12), (p = 22 >= p ? p : 22)), p && g.l.Kc && (p *= 2)));
            f = !1;
            this.Es === d ? (f = !0) : void 0 !== e && this.Es === d + '-' + e && (f = !0);
            f && ((h = this.iv(h || a)), (k = this.iv(k || b)), (l = this.iv(l || c)), (q = 1 - 1.6 * this.AD), (n = m = !0));
        ...
        Ny: function (a, b, c, d, e) {
            ...
            d = d ? this.lq : this.fl;
            var l = e || this.Hj;
            if ((f = this.sD(c, e))) ('function' === typeof f.visible && !f.visible(l)) || !1 === f.visible ? (h = k = '') : ((h = d(a, f.me, f.fillColor, !1, l)), (k = d(b, f.qb, f.strokeColor, !1, l)));
            this.Es === c && ((b = k || b), (h = this.iv(h || a)), (k = this.iv(b)));
            return [h, k];
        },
    };
    g.M.Sb.Ib(g.V2);
    g.M.canvas.Sb = g.M.Sb.extend({
        ...
        pc: function (a) {
            ...
            this.T = b.T;
            if (!this.Na || 1e4 < Math.abs(b.mb.x - this.Na.x) / this.T || 1e4 < Math.abs(b.mb.y - this.Na.y) / this.T) this.Na = b.mb;
            this.Na.x - b.mb.x < -g.a.Fa / 2 ? (this.Na = new g.H(this.Na.x + g.a.Fa, this.Na.y)) : this.Na.x - b.mb.x > g.a.Fa / 2 && (this.Na = new g.H(this.Na.x - g.a.Fa, this.Na.y));
            for (var h = 0; h < c.length; h += 1) {
                var k = c[h],
                    l = this.Bs(k),
                    m = c[h].ne();
                if (l && l.g)
                    if (!m.visible || k.ZD || m.Za[0] > b.zoom || m.Za[1] < b.zoom || (k.ha && 0 === k.ha.length)) {
                        if ((l = l.vj()))
                            if (l.length) for (m = 0; m < l.length; m += 1) l[m].parentNode === this.K && this.K.removeChild(l[m]);
                        ...
                        var k = l.vj(),
                            ...
                            p,
                            q = l.transform;
                        if (!q || !k || (l.Di && !this.e.D.Ra)) c[h].zj && k.parentNode !== this.K && (this.K.appendChild(k), (c[h].Ob = k));
                        else {
                            c[h].Ob = k;
                            k.length || ((k = [k]), (q = [q]));
    ...
    g.M.Ui = g.M.Zb.extend({
        A: function (a, b) {
            ...
            this.oa.zC = function (a) {
                return a.pb ? ((a.pb.Tg -= 1), 0 == a.pb.Tg && (a.Bv = !1), delete a.pb, !0) : a.Bv ? (a.Tg ? !1 : !0) : !0;
            };
            this.hd = 1;
            this.ao = 50;
            this.rX = !0;
        ...
        yh: function (a, b, c) {
            function d(b) {
                a.loaded = !0;
                e.g && ((a.status = 'loaded'), (a.Ba = !0), (a.kd = b), e.set('display', 0), 'function' === typeof c && c());
            }
            var e = this;
            a.status = 'loading';
            this.g.Do &&
                this.g.Do.call(this, a, d, function () {
                    a.loaded = !0;
        ...
        aIa: function (a, b, c, d) {
            ...
            for (var f = 0; f < a.length; f += 1) {
                ...
                } else (h = new g.qr(c, k, h)), (k = h + ''), (h = new g.sb(h));
            ...
            if (this.g.wH) {
                var e,
                    ...
                    p = (function () {
                        ...
                        if (0 == p) return b.call(c, a), { vL: void 0 };
                        d.gV = a;
                        for (e = a.length - 1; 0 <= e; e -= 1)
                            for (f = a[e], h = [], k = [], f.YT = h, f.Mv = k, l = f.length - 1; 0 <= l; l -= 1)
                                (m = f[l]),
                                    (n = m.ta),
                                    c.g.e.Se.PE(
                                        n.x,
                                            ...
                                            return function (e) {
                                                ...
                                                if (0 == p) {
                                                    for (e = a.length - 1; 0 <= e; e -= 1) {
                                                        ...
                                                        a[e] = l.YT;
                                                        if (l.Mv)
                                                            for (var m = l.Mv.length - 1; 0 <= m; m -= 1) {
                                                                var n = l.Mv[m];
                                                                n.status = 'loaded';
                                                                n.loaded = !0;
                                                                n.Ba = !0;
                ...
                if ('object' === typeof p) return p.vL;
            } else b.call(this, a);
        },
        sw: function (a, b, c) {
        ...
        lJ: function (a) {
            ...
            var c = b.y,
                ...
                h = null;
            e !== a && (h = this.sw(b, e, c));
            h || d === a || (h = this.sw(b, d, c));
            h || f === a || (h = this.sw(b, f, c));
            return h;
        },
        Gn: function (a) {
            var b = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : !1;
                    ...
                    for (var c = a.length - 1; 0 <= c; c -= 1) {
                        ...
                        if (d.length)
                            for (var e = Math.pow(2, 20 - d[0].ta.z), c = d.length - 1; 0 <= c; c--) {
                                ...
                                if (10 > h.z) {
                                    var k = this.lJ(f);
                                    k && ((f.pb = k), (f.status = 'loaded'), (f.Ba = !0), (k.Tg += 1), (f.bl = (h.x - k.ta.x) / Math.pow(2, h.z)), d.splice(c, 1), this.set('display', 0));
                                }
                                this.oa.set(f.key, f);
                        ...
                        for (var c = a.length - 1; 0 <= c; c -= 1) {
                            ...
                            if (d.length)
                                if (l.Ei) {
                                    ...
                                    var e = d[0].ta.z;
                                    l.gw(d, l.kl ? 1 : 0);
                                    for (var f = 0, h = 0; f < d.length; ) l.WS(d.slice(10 * h, 10 * h + 10), e, b), (f += 10), (h += 1);
                                } else
                                    for (
                                        e = (function () {
                                            var a = d.length;
        ...
        gw: function (a, b) {
            if (a.length) {
                var c = this.mb.md(this.Fd << (20 - a[0].ta.z)),
                    d = Math.floor(c.x),
                    e = Math.floor(c.y);
                a.sort(function (a, c) {
                    var k = a.ta,
        ...
        ip: function (a, b) {
            ...
            this.zoom = c.zoom;
            this.oe = c.oe;
            this.gb = 'AMap.MapBox' == this.g.S.CLASS_NAME ? Math.max(2, this.oe - g.o.Wn) : !1 === this.Ei && !this.g.pS && this.g.ja ? this.oe + 1 : this.oe;
            this.gf && this.gb > this.gf && (this.gb = this.gf);
            this.$o && this.gb < this.$o && (this.gb = this.$o);
            this.T = c.T;
            this.Hg = c.Hg;
            c = a.P.Ha;
            this.qk = this.ty(c, b.I);
            this.Iw = c.P$ ? this.ty(c.P$, b.I) : null;
            var c = this.qk,
                d = this.Ha.H9,
                e = null,
                e = d < this.zoom && this.Iw ? this.Iw : c,
                f = [],
                h = [],
                k,
                l = [],
            ...
            for (q = m.length - 1; 0 <= q; q -= 1)
                if (((k = m[q]), !(k.jx < b.opacity)))
                    if (((p.z = k.ta.z), (p.x = k.ta.x), (p.y = k.ta.y), p.z === this.gb)) s[p + ''] |= 16;
                    else if (p.z < this.gb) {
            ...
            q = !0;
            this.oa.E2();
            for (x = e.Jc; x <= e.Ic; x += 1) for (p.x = x, y = e.hc; y <= e.tc; y += 1) (p.y = y), (k = this.Uy(p)), this.cu(k), (v = !1), k.Ba ? ((k.fe = this.fe), this.wv(c, x, y) && (m.push(k), this.Jl && (k.hd !== this.hd || 1 > k.jx) && (v = !0))) : ((q = !1), this.wv(c, x, y) && (v = !0), (k.status && !k.Je) || this.oe !== d || (this.Iw && !this.wv(this.Iw, x, y)) || l.push(k)), v && n.push(k);
            ...
            if (this.Zi) {
                n = n.slice(0);
                l = [];
                for (q = n.length - 1; 0 <= q; q -= 1) (k = n[q]), s[k.key] & 4 || l.push(k);
                k = b.Za[1];
                for (r = this.gb + 1; n.length && r <= k; r += 1) {
                    ...
                    n = [];
                    p.z = r;
                    for (q = d.length - 1; 0 <= q; q -= 1) if (((x = d[q]), (v = s[x.key]), v & 7)) for (v = x.ta.x << 1, w = x.ta.y << 1, x = 1; 0 <= x; x -= 1) for (p.x = v + x, y = 1; 0 <= y; y -= 1) (p.y = w + y), (E = p + ''), (t = this.oa.rK(E)), s[E] & 5 && t && t.Ba ? ((t.KB = !0), (t.fe = this.fe), m.push(t), this.cu(t)) : n.push(new g.sb(p.eb()));
                    m.length && ((e = !0), f.push(m));
                }
                n = l;
            }
            if (!e && this.$i)
                for (x = !f.length || this.kl ? b.Za[0] : Math.max(b.Za[0], this.gb - 2), Math.max(x, this.gb - this.eha), r = this.gb - 1; n.length && r >= x; r -= 1) {
                    m = [];
                    y = {};
                    d = n;
                    n = [];
                    for (q = d.length - 1; 0 <= q; q -= 1) (k = d[q]), (p.z = r), (p.x = k.ta.x >> 1), (p.y = k.ta.y >> 1), (k = this.Uy(p)), y[k.key] || ((y[k.key] = 1), (v = !1), k.Ba && (!this.eja || s[k.key] & 64) ? ((p.x = Math.min(c.Ic, Math.max(c.Jc, p.x << (this.gb - r)))), (p.y = Math.min(c.tc, Math.max(c.hc, p.y << (this.gb - r)))), (p.z = this.gb), (E = p + ''), 'number' === typeof u[E] && k.ta.z > u[E] ? (v = !0) : (k.KB = !0), (k.fe = this.fe), m.push(k), this.cu(k)) : (v = !0), v && n.push(k));
                    m.length && f.push(m);
                }
            this.gV = h;
            this.Hv = this.Aq = 0;
        ...
        JR: function (a, b) {
            for (var c = [], d = this.e.D.getCoordsBoundByZoom(a), d = this.ty(d, b, a), e = d.Jc; e < d.Ic; e++)
                for (var f = d.hc; f < d.tc; f++) {
                    var h = [a, e, f].join('/');
                    this.oa.Nd(h) || c.push(new g.sb(new g.qr(a, e, f), !0));
                }
            return c;
        },
        OX: function () {
            var a = this.e.D;
            return a.Y7 && a.get('preloadMode') && 200 <= this.oa.Kp && this.g.S.wq() && 'stable' != this.Hf && this.$x && this.$x() && this.zoom !== this.gb;
        },
        oE: function (a, b) {
            var c = b.I,
                d = b.Za;
    ...
    g.M.ce.Ui = g.M.Ui.extend({
        ...
        Yv: function (a) {
            var b = Math.pow(2, a.P.zoom - this.Df),
                c = a.P.mb.bb(this.Ls).md(this.ym);
        ...
        pc: function (a, b) {
            ...
            this.hf = a.hf;
            this.ip(a, b);
            this.Ls && g.l.Zl && (a.he || a.hf) ? this.Yv(a, b) : this.Nz(a, b);
            this.Ls = this.mb;
            this.ze && this.set('display', 0);
        },
        Xv: function () {
            for (var a = this.Ob.childNodes, b = a.length - 1; 0 <= b; b -= 1) a[b] && a[b].hd !== this.hd && this.Ob.removeChild(a[b]);
        },
        sE: function (a, b) {
                ...
                if (((f = a[d]), f.length)) {
                    ...
                    for (var r = f.length - 1; 0 <= r; r -= 1) {
                        ...
                        if (this.Na === n.Na && n.Df === this.Df) {
                            var s = n.kd;
                            if (s && s.parentNode === this.Ob && 1 === n.jx) {
                                h.push(n);
                                s.hd = this.hd;
                                n.hd = this.hd;
                                continue;
                        ...
                        u.y = g.a.xb(u.y, 1);
                        var v = 1;
                        if (!n.nY || (this.rX && n.hd !== b)) n.nY = this.currentTime;
                        this.Jl && !n.KB ? ((v = Math.max(0, Math.abs(m.z - this.zoom) - 1)), (v = Math.min(1, (this.currentTime - n.nY) / ((1 / Math.pow(1.32, v)) * this.ao))), 1 !== v && (this.ze = !0)) : (n.KB = !1);
                        n.hd = this.hd;
                        n.jx = v;
                        n.Ba ? ((s = n.kd), !s && n.pb && n.pb.kd && ('CANVAS' === n.pb.kd.tagName ? ((s = document.createElement('canvas')), (s.width = n.pb.kd.width), (s.height = n.pb.kd.height), s.getContext('2d').drawImage(n.pb.kd, 0, 0, s.width, s.height), (n.kd = s), (n.pb.Tg -= 1), (n.pb = null), (n.bl = 0)) : 'IMG' === n.pb.kd.tagName ? ((s = document.createElement('img')), (s.src = n.pb.kd.src), (n.kd = s), (n.pb.Tg -= 1), (n.pb = null), (n.bl = 0)) : (s = n.pb.kd)), 0 !== v && s && (this.i4(s, u.x, u.y, p, p, v, m.z), s.parentNode !== this.Ob && (g.l.Ai && 'overlayer' === this.g.get('type') && (s.style.display = 'none'), this.ev.appendChild(s)), (s.hd = this.hd), (n.oe = this.oe), h.push(n))) : (n.fe = null);
                    }
                    e = !0;
                }
        ...
        oU: function () {},
        Oe: function () {
            this.transform = { translate: this.cQ, scale: Math.pow(2, this.zoom - this.oe), rotate: 0 };
        },
    });
    window.CanvasRenderingContext2D &&
        ((window.CanvasRenderingContext2D.prototype.CQ = function (a, b, c, d, e) {
            ...
            c = h / k;
            e.Fg = 0;
            for (var l = [], f = this.uI, m = 0, n = 0, p = !1, q = (h = 0); q < e.length; q += 1) (e.Fg += e[q]), (l[q] = { cD: e[q] * d, dD: e[q] * c, gz: (h += e[q]) }), (f -= e[q]), 0 > f && !p && ((m = q), (n = -f), (p = !0));
            for (p = 0; n + p <= k; ) n < e[m] ? ((f = n * d), (h = n * c)) : ((f = l[m].cD), (h = l[m].dD)), (a += f), (b += h), this.JE ? this.moveTo(a, b) : this.lineTo(a, b), (p += n), (this.JE = !this.JE), (n = e[(m + 1) % e.length]), (m = (m + 1) % e.length);
            k -= p;
            a += k * d;
            b += k * c;
    ...
    g.M.Le.Hl = g.M.Ui.extend({
        ...
        wt: function (a, b) {
            ...
            this.ph = a.P.ph;
            var c = !1;
            if (!this.Na || 500 < Math.abs(this.nb.x - this.Na.x) / this.T || 500 < Math.abs(this.nb.y - this.Na.y) / this.T) c = !0;
            if (c || this.zoom << 0 !== this.zoom || this.Df !== this.zoom) (this.Na = this.nb), (this.Df = this.zoom);
        },
        lv: function (a) {
        ...
        Oe: function () {
            ...
            this.transform = { translate: this.Na.bb(this.nb).md(this.T), scale: a, rotate: 0 };
        },
    });
    g.M.Le.gd = g.da.extend({
        A: function (a) {
            this.ql = a;
        },
        yE: function (a, b) {
            ...
            for (f in a)
                if (a.hasOwnProperty(f)) {
                    ...
                    if (!m)
                        ...
                        } else if (h.eba || this.zoom << 0 !== this.zoom || h.zoom !== this.zoom || k.parentNode !== this.ql || h.Na !== this.Na) (x = this.Mu(h.W.za)), (h.Na = this.Na), (y = l.pF), (r = Math.round(x[1] + r + y.y)), (q = Math.round(x[0] + q + y.x)), (k.style.top = r + 'px'), (k.style.left = q + 'px');
                    h.zoom = this.zoom;
    ...
    if (Vc) for (Jc = 0; Jc < Wc.length; Jc += 1) g.ub.SC(Wc[Jc]).status = 1;
    else (Nc.OJ = !1), id();
    function jd() {
    ...
    function id() {
        ...
        jd()
            ? kd(a)
            : (fa.write('<script crossorigin="anonymous" id="amap_plus_js" src="' + a + '" type="text/javascript">\x3c/script>'),
              setTimeout(function () {
    ...
    function fd() {
        ...
        b.type = 'text/css';
        -1 === Nc.Hb.indexOf('webapi.amap.com') && (a = a.replace(/webapi.amap.com/gi, Nc.Hb.split('://')[1]));
...
})(['e2b04289e870b005374ee030148d64fd', [112.721177, 34.262109, 114.220961, 34.989506, 113.665412, 34.757975], 'https://webapi.amap.com', 1, '1.4.18', null, '410100', '', true, false, false, true, '20211117211203-20201123-1', false, 'D', '3_21_12_07_00', 'https', 'webapi.amap.com']);
